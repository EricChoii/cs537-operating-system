...
main(int argc, char *argv[])
{
  ...
  38:	68 48 09 00 00       	push   $0x948
  3d:	83 c3 04             	add    $0x4,%ebx
  40:	50                   	push   %eax
  41:	68 4a 09 00 00       	push   $0x94a
  46:	6a 01                	push   $0x1
  ...
  57:	68 4f 09 00 00       	push   $0x94f
  5c:	50                   	push   %eax
  5d:	68 4a 09 00 00       	push   $0x94a
  62:	6a 01                	push   $0x1
  64:	e8 77 05 00 00       	call   5e0 <printf>
  69:	83 c4 10             	add    $0x10,%esp
  exit();
  6c:	e8 07 04 00 00       	call   478 <exit>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
...
int thread_create(void (*start_routine)(void *, void *), void* arg1, void* arg2)
{
 ...
 308:	b9 e0 0c 00 00       	mov    $0xce0,%ecx
 ...
 32e:	89 82 e4 0c 00 00    	mov    %eax,0xce4(%edx)
      ptrs[i].stack = stack;
 334:	89 9a e8 0c 00 00    	mov    %ebx,0xce8(%edx)
      ptrs[i].busy = 1;
 33a:	c7 82 e0 0c 00 00 01 	movl   $0x1,0xce0(%edx)
 341:	00 00 00 
      break;
    }
  }
 ...
 389:	8d 45 e4             	lea    -0x1c(%ebp),%eax
{
 ...
 396:	ba e0 0c 00 00       	mov    $0xce0,%edx
 ...
 3ce:	ff b6 e4 0c 00 00    	pushl  0xce4(%esi)
 ...
 3d9:	83 c4 10             	add    $0x10,%esp
      ptrs[i].stack = NULL;
 3dc:	c7 86 e8 0c 00 00 00 	movl   $0x0,0xce8(%esi)
 3e3:	00 00 00 
      ptrs[i].busy = 0;
 3e6:	c7 86 e0 0c 00 00 00 	movl   $0x0,0xce0(%esi)
 3ed:	00 00 00 
      ptrs[i].ptr = NULL;
 3f0:	c7 86 e4 0c 00 00 00 	movl   $0x0,0xce4(%esi)
 3f7:	00 00 00 
    }
  }
  return ret;  
...
printf(int fd, const char *fmt, ...)
{
 ...
 764:	eb 1a                	jmp    780 <printf+0x1a0>
          s = "(null)";
 766:	bb 51 09 00 00       	mov    $0x951,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7b5:	a1 c0 0c 00 00       	mov    0xcc0,%eax
{
 ...
 7d6:	73 10                	jae    7e8 <free+0x38>
{
 ...
 801:	5b                   	pop    %ebx
  freep = p;
 802:	a3 c0 0c 00 00       	mov    %eax,0xcc0
}
 807:	5e                   	pop    %esi
 808:	5f                   	pop    %edi
 809:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 84d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 850:	8b 3d c0 0c 00 00    	mov    0xcc0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 899:	8b 3d c0 0c 00 00    	mov    0xcc0,%edi
 ...
 8c2:	e8 e9 fe ff ff       	call   7b0 <free>
  return freep;
 8c7:	a1 c0 0c 00 00       	mov    0xcc0,%eax
 ...
 8f4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 8f7:	a3 c0 0c 00 00       	mov    %eax,0xcc0
}
 ...
 90e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 910:	c7 05 c0 0c 00 00 c4 	movl   $0xcc4,0xcc0
 917:	0c 00 00 
    base.s.size = 0;
 91a:	bf c4 0c 00 00       	mov    $0xcc4,%edi
    base.s.ptr = freep = prevp = &base;
 91f:	c7 05 c4 0c 00 00 c4 	movl   $0xcc4,0xcc4
 926:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 929:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 92b:	c7 05 c8 0c 00 00 00 	movl   $0x0,0xcc8
 932:	00 00 00 
    if(p->s.size >= nunits){

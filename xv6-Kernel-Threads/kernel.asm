...
8010005a:	e8 91 46 00 00       	call   801046f0 <initlock>
  bcache.head.next = &bcache.head;
...
801001c2:	e8 c9 44 00 00       	call   80104690 <holdingsleep>
...
80100203:	e8 88 44 00 00       	call   80104690 <holdingsleep>
...
80100213:	e8 38 44 00 00       	call   80104650 <releasesleep>
...
8010026f:	5d                   	pop    %ebp
  release(&bcache.lock);
80100270:	e9 bb 46 00 00       	jmp    80104930 <release>
    panic("brelse");
...
801002b1:	e8 ba 45 00 00       	call   80104870 <acquire>
...
8010030e:	e8 1d 46 00 00       	call   80104930 <release>
        ilock(ip);
80100313:	5a                   	pop    %edx
...
80100365:	e8 c6 45 00 00       	call   80104930 <release>
  ilock(ip);
8010036a:	58                   	pop    %eax
...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 3f 7e 10 80 	movl   $0x80107e3f,(%esp)
...
801003dc:	e8 2f 43 00 00       	call   80104710 <getcallerpcs>
  for(i=0; i<10; i++)
...
80100561:	e8 ba 44 00 00       	call   80104a20 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100576:	e8 05 44 00 00       	call   80104980 <memset>
...
8010065f:	e8 0c 42 00 00       	call   80104870 <acquire>
  for(i = 0; i < n; i++)
...
80100697:	e8 94 42 00 00       	call   80104930 <release>
  ilock(ip);
8010069c:	58                   	pop    %eax
...
801007bd:	e8 ae 40 00 00       	call   80104870 <acquire>
...
80100828:	e8 03 41 00 00       	call   80104930 <release>
...
80100877:	e8 f4 3f 00 00       	call   80104870 <acquire>
  while((c = getc()) >= 0){
...
801009cf:	e8 5c 3f 00 00       	call   80104930 <release>
  if(doprocdump) {
...
801009ff:	e9 cc 3a 00 00       	jmp    801044d0 <procdump>
...
80100a20:	e8 ab 39 00 00       	call   801043d0 <wakeup>
...
80100a44:	e8 a7 3c 00 00       	call   801046f0 <initlock>
...
80100ca3:	e8 d8 3e 00 00       	call   80104b80 <strlen>
...
80100cb6:	e8 c5 3e 00 00       	call   80104b80 <strlen>
...
80100d71:	e8 ca 3d 00 00       	call   80104b40 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100df4:	e8 f7 38 00 00       	call   801046f0 <initlock>
}
...
80100e15:	e8 56 3a 00 00       	call   80104870 <acquire>
...
80100e41:	e8 ea 3a 00 00       	call   80104930 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e5a:	e8 d1 3a 00 00       	call   80104930 <release>
}
...
80100e83:	e8 e8 39 00 00       	call   80104870 <acquire>
  if(f->ref < 1)
...
80100ea0:	e8 8b 3a 00 00       	call   80104930 <release>
  return f;
}
...
80100ed5:	e8 96 39 00 00       	call   80104870 <acquire>
  if(f->ref < 1)
...
80100f0d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f10:	e8 1b 3a 00 00       	call   80104930 <release>
...
80100f3d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f3e:	e9 ed 39 00 00       	jmp    80104930 <release>
...
80101315:	e8 66 36 00 00       	call   80104980 <memset>
  log_write(bp);
...
801013c7:	e8 64 35 00 00       	call   80104930 <release>
...
801013f2:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801013f5:	e8 36 35 00 00       	call   80104930 <release>
      return ip;
...
80101525:	e8 f6 34 00 00       	call   80104a20 <memmove>
  brelse(bp);
...
8010155a:	e8 91 31 00 00       	call   801046f0 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101577:	e8 34 30 00 00       	call   801045b0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010165e:	e8 1d 33 00 00       	call   80104980 <memset>
      dip->type = type;
...
80101705:	e8 16 33 00 00       	call   80104a20 <memmove>
  log_write(bp);
...
80101743:	e8 28 31 00 00       	call   80104870 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101753:	e8 d8 31 00 00       	call   80104930 <release>
}
...
80101786:	e8 65 2e 00 00       	call   801045f0 <acquiresleep>
  if(ip->valid == 0){
...
801017f8:	e8 23 32 00 00       	call   80104a20 <memmove>
    brelse(bp);
...
80101857:	e8 34 2e 00 00       	call   80104690 <holdingsleep>
...
80101872:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101873:	e9 d8 2d 00 00       	jmp    80104650 <releasesleep>
    panic("iunlock");
...
801018a4:	e8 47 2d 00 00       	call   801045f0 <acquiresleep>
...
801018be:	e8 8d 2d 00 00       	call   80104650 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801018ca:	e8 a1 2f 00 00       	call   80104870 <acquire>
  ip->ref--;
...
801018e3:	5d                   	pop    %ebp
  release(&icache.lock);
801018e4:	e9 47 30 00 00       	jmp    80104930 <release>
801018e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&icache.lock);
801018f0:	83 ec 0c             	sub    $0xc,%esp
801018f3:	68 e0 09 11 80       	push   $0x801109e0
801018f8:	e8 73 2f 00 00       	call   80104870 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101907:	e8 24 30 00 00       	call   80104930 <release>
    if(r == 1){
...
80101b07:	e8 14 2f 00 00       	call   80104a20 <memmove>
    brelse(bp);
...
80101c03:	e8 18 2e 00 00       	call   80104a20 <memmove>
    log_write(bp);
...
80101ca2:	e8 e9 2d 00 00       	call   80104a90 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101d05:	e8 86 2d 00 00       	call   80104a90 <strncmp>
      continue;
...
80101d9c:	e8 cf 2a 00 00       	call   80104870 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101dac:	e8 7f 2b 00 00       	call   80104930 <release>
...
80101e17:	e8 04 2c 00 00       	call   80104a20 <memmove>
...
80101ea3:	e8 78 2b 00 00       	call   80104a20 <memmove>
    name[len] = 0;
...
80101fd5:	e8 06 2b 00 00       	call   80104ae0 <strncpy>
...
80102020:	68 26 7c 10 80       	push   $0x80107c26
...
80102086:	81 fe 9f 0f 00 00    	cmp    $0xf9f,%esi
...
80102164:	e8 87 25 00 00       	call   801046f0 <initlock>
...
801021f2:	e8 79 26 00 00       	call   80104870 <acquire>
...
8010224d:	e8 7e 21 00 00       	call   801043d0 <wakeup>
...
8010226b:	e8 c0 26 00 00       	call   80104930 <release>
...
80102292:	e8 f9 23 00 00       	call   80104690 <holdingsleep>
...
801022cc:	e8 9f 25 00 00       	call   80104870 <acquire>
...
80102335:	c9                   	leave  
  release(&idelock);
80102336:	e9 f5 25 00 00       	jmp    80104930 <release>
...
80102486:	81 fb e8 56 11 80    	cmp    $0x801156e8,%ebx
...
801024a6:	e8 d5 24 00 00       	call   80104980 <memset>
...
801024e0:	e8 8b 23 00 00       	call   80104870 <acquire>
...
801024fa:	c9                   	leave  
    release(&kmem.lock);
801024fb:	e9 30 24 00 00       	jmp    80104930 <release>
    panic("kfree");
...
80102579:	e8 72 21 00 00       	call   801046f0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102663:	e8 08 22 00 00       	call   80104870 <acquire>
  r = kmem.freelist;
...
80102691:	e8 9a 22 00 00       	call   80104930 <release>
  return (char*)r;
...
80102abf:	e8 0c 1f 00 00       	call   801049d0 <memcmp>
...
80102bf4:	e8 27 1e 00 00       	call   80104a20 <memmove>
...
80102ca8:	e8 43 1a 00 00       	call   801046f0 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102d3f:	e8 2c 1b 00 00       	call   80104870 <acquire>
...
80102d94:	e8 97 1b 00 00       	call   80104930 <release>
      break;
    }
  }
}
...
80102db2:	e8 b9 1a 00 00       	call   80104870 <acquire>
  log.outstanding -= 1;
...
80102df0:	e8 3b 1b 00 00       	call   80104930 <release>
}
...
80102e0a:	e8 61 1a 00 00       	call   80104870 <acquire>
    wakeup(&log);
...
80102e1d:	00 00 00 
    wakeup(&log);
80102e20:	e8 ab 15 00 00       	call   801043d0 <wakeup>
    release(&log.lock);
80102e25:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102e2c:	e8 ff 1a 00 00       	call   80104930 <release>
...
80102e84:	e8 97 1b 00 00       	call   80104a20 <memmove>
...
80102ed8:	e8 f3 14 00 00       	call   801043d0 <wakeup>
  release(&log.lock);
80102edd:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102ee4:	e8 47 1a 00 00       	call   80104930 <release>
...
80102f52:	e8 19 19 00 00       	call   80104870 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f94:	c9                   	leave  
  release(&log.lock);
80102f95:	e9 96 19 00 00       	jmp    80104930 <release>
...
8010305b:	68 e8 56 11 80       	push   $0x801156e8
...
801030b8:	e8 63 19 00 00       	call   80104a20 <memmove>
...
801031a4:	e8 27 18 00 00       	call   801049d0 <memcmp>
...
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 68 17 00 00       	call   801049d0 <memcmp>
...
8010346d:	e8 7e 12 00 00       	call   801046f0 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 58 13 00 00       	call   80104870 <acquire>
  if(writable){
...
80103533:	e8 98 0e 00 00       	call   801043d0 <wakeup>
...
80103557:	5d                   	pop    %ebp
    release(&p->lock);
80103558:	e9 d3 13 00 00       	jmp    80104930 <release>
...
80103574:	e8 57 0e 00 00       	call   801043d0 <wakeup>
...
80103584:	e8 a7 13 00 00       	call   80104930 <release>
    kfree((char*)p);
...
801035b1:	e8 ba 12 00 00       	call   80104870 <acquire>
  for(i = 0; i < n; i++){
...
80103608:	e8 c3 0d 00 00       	call   801043d0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010360d:	58                   	pop    %eax
8010360e:	5a                   	pop    %edx
...
8010363c:	e8 ef 12 00 00       	call   80104930 <release>
        return -1;
...
8010368a:	e8 41 0d 00 00       	call   801043d0 <wakeup>
  release(&p->lock);
8010368f:	89 1c 24             	mov    %ebx,(%esp)
80103692:	e8 99 12 00 00       	call   80104930 <release>
  return n;
...
801036ba:	e8 b1 11 00 00       	call   80104870 <acquire>
...
80103756:	e8 75 0c 00 00       	call   801043d0 <wakeup>
  release(&p->lock);
8010375b:	89 34 24             	mov    %esi,(%esp)
8010375e:	e8 cd 11 00 00       	call   80104930 <release>
  return i;
...
80103779:	e8 b2 11 00 00       	call   80104930 <release>
      return -1;
...
801037a1:	e8 ca 10 00 00       	call   80104870 <acquire>
...
801037b6:	81 fb 94 4e 11 80    	cmp    $0x80114e94,%ebx
...
801037db:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037de:	68 60 2d 11 80       	push   $0x80112d60
  p->pid = nextpid++;
801037e3:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e9:	e8 42 11 00 00       	call   80104930 <release>
...
8010380b:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
8010380e:	c7 40 14 5f 5c 10 80 	movl   $0x80105c5f,0x14(%eax)
  p->context = (struct context*)sp;
...
8010381d:	e8 5e 11 00 00       	call   80104980 <memset>
...
80103843:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103845:	68 60 2d 11 80       	push   $0x80112d60
8010384a:	e8 e1 10 00 00       	call   80104930 <release>
}
...
80103877:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
8010387a:	68 60 2d 11 80       	push   $0x80112d60
8010387f:	e8 ac 10 00 00       	call   80104930 <release>
...
801038ca:	68 00 7a 10 80       	push   $0x80107a00
801038cf:	68 60 2d 11 80       	push   $0x80112d60
801038d4:	e8 17 0e 00 00       	call   801046f0 <initlock>
  initlock(&memlock, "memlock");
801038d9:	58                   	pop    %eax
801038da:	5a                   	pop    %edx
801038db:	68 07 7a 10 80       	push   $0x80107a07
801038e0:	68 20 2d 11 80       	push   $0x80112d20
801038e5:	e8 06 0e 00 00       	call   801046f0 <initlock>
}
...
80103988:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010398b:	e8 e0 0d 00 00       	call   80104770 <pushcli>
  c = mycpu();
80103990:	e8 5b ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103995:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010399b:	e8 20 0e 00 00       	call   801047c0 <popcli>
}
...
801039c7:	e8 54 38 00 00       	call   80107220 <setupkvm>
...
801039e5:	e8 06 35 00 00       	call   80106ef0 <inituvm>
...
801039f7:	ff 73 1c             	pushl  0x1c(%ebx)
801039fa:	e8 81 0f 00 00       	call   80104980 <memset>
...
80103a0f:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a13:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80103a44:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103a47:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a4e:	8d 43 70             	lea    0x70(%ebx),%eax
80103a51:	6a 10                	push   $0x10
80103a53:	68 38 7a 10 80       	push   $0x80107a38
80103a58:	50                   	push   %eax
80103a59:	e8 e2 10 00 00       	call   80104b40 <safestrcpy>
  p->cwd = namei("/");
80103a5e:	c7 04 24 41 7a 10 80 	movl   $0x80107a41,(%esp)
80103a65:	e8 c6 e5 ff ff       	call   80102030 <namei>
80103a6a:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
80103a6d:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
80103a74:	e8 f7 0d 00 00       	call   80104870 <acquire>
  p->state = RUNNABLE;
80103a79:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  release(&ptable.lock);
80103a80:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
80103a87:	e8 a4 0e 00 00       	call   80104930 <release>
}
...
80103a97:	68 1f 7a 10 80       	push   $0x80107a1f
...
80103ab9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103abc:	e8 af 0c 00 00       	call   80104770 <pushcli>
  c = mycpu();
80103ac1:	e8 2a fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103ac6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103acc:	e8 ef 0c 00 00       	call   801047c0 <popcli>
  sz = curproc->sz;
80103ad1:	8b 13                	mov    (%ebx),%edx
  if(n > 0){
80103ad3:	85 f6                	test   %esi,%esi
80103ad5:	7f 4c                	jg     80103b23 <growproc+0x73>
  } else if(n < 0){
80103ad7:	75 6f                	jne    80103b48 <growproc+0x98>
  curproc->sz = sz;
80103ad9:	89 13                	mov    %edx,(%ebx)
  for(process = ptable.proc; process < &ptable.proc[NPROC]; process++) {
80103adb:	b8 94 2d 11 80       	mov    $0x80112d94,%eax
80103ae0:	eb 12                	jmp    80103af4 <growproc+0x44>
80103ae2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103ae8:	05 84 00 00 00       	add    $0x84,%eax
80103aed:	3d 94 4e 11 80       	cmp    $0x80114e94,%eax
80103af2:	74 1a                	je     80103b0e <growproc+0x5e>
    if (curproc != process && process->pgdir == curproc->pgdir)
80103af4:	39 c3                	cmp    %eax,%ebx
80103af6:	74 f0                	je     80103ae8 <growproc+0x38>
80103af8:	8b 4b 04             	mov    0x4(%ebx),%ecx
80103afb:	39 48 04             	cmp    %ecx,0x4(%eax)
80103afe:	75 e8                	jne    80103ae8 <growproc+0x38>
      process->sz = sz;
80103b00:	89 10                	mov    %edx,(%eax)
  for(process = ptable.proc; process < &ptable.proc[NPROC]; process++) {
80103b02:	05 84 00 00 00       	add    $0x84,%eax
80103b07:	3d 94 4e 11 80       	cmp    $0x80114e94,%eax
80103b0c:	75 e6                	jne    80103af4 <growproc+0x44>
  switchuvm(curproc);
80103b0e:	83 ec 0c             	sub    $0xc,%esp
80103b11:	53                   	push   %ebx
80103b12:	e8 c9 32 00 00       	call   80106de0 <switchuvm>
  return 0;
80103b17:	83 c4 10             	add    $0x10,%esp
80103b1a:	31 c0                	xor    %eax,%eax
}
...
80103b26:	01 d6                	add    %edx,%esi
80103b28:	56                   	push   %esi
80103b29:	52                   	push   %edx
80103b2a:	ff 73 04             	pushl  0x4(%ebx)
80103b2d:	e8 0e 35 00 00       	call   80107040 <allocuvm>
80103b32:	83 c4 10             	add    $0x10,%esp
80103b35:	89 c2                	mov    %eax,%edx
80103b37:	85 c0                	test   %eax,%eax
80103b39:	75 9e                	jne    80103ad9 <growproc+0x29>
      return -1;
80103b3b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103b40:	eb da                	jmp    80103b1c <growproc+0x6c>
80103b42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if((sz = deallocuvm(curproc->pgdir, sz, sz + n)) == 0)
80103b48:	83 ec 04             	sub    $0x4,%esp
80103b4b:	01 d6                	add    %edx,%esi
80103b4d:	56                   	push   %esi
80103b4e:	52                   	push   %edx
80103b4f:	ff 73 04             	pushl  0x4(%ebx)
80103b52:	e8 19 36 00 00       	call   80107170 <deallocuvm>
80103b57:	83 c4 10             	add    $0x10,%esp
80103b5a:	89 c2                	mov    %eax,%edx
80103b5c:	85 c0                	test   %eax,%eax
80103b5e:	0f 85 75 ff ff ff    	jne    80103ad9 <growproc+0x29>
80103b64:	eb d5                	jmp    80103b3b <growproc+0x8b>
...
80103b7a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b7d:	e8 ee 0b 00 00       	call   80104770 <pushcli>
  c = mycpu();
80103b82:	e8 69 fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b87:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b8d:	e8 2e 0c 00 00       	call   801047c0 <popcli>
  if((np = allocproc()) == 0){
80103b92:	e8 f9 fb ff ff       	call   80103790 <allocproc>
80103b97:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103b9a:	85 c0                	test   %eax,%eax
80103b9c:	0f 84 bb 00 00 00    	je     80103c5d <fork+0xed>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103ba2:	83 ec 08             	sub    $0x8,%esp
80103ba5:	ff 33                	pushl  (%ebx)
80103ba7:	89 c7                	mov    %eax,%edi
80103ba9:	ff 73 04             	pushl  0x4(%ebx)
80103bac:	e8 3f 37 00 00       	call   801072f0 <copyuvm>
80103bb1:	83 c4 10             	add    $0x10,%esp
80103bb4:	89 47 04             	mov    %eax,0x4(%edi)
80103bb7:	85 c0                	test   %eax,%eax
80103bb9:	0f 84 a5 00 00 00    	je     80103c64 <fork+0xf4>
  np->sz = curproc->sz;
80103bbf:	8b 03                	mov    (%ebx),%eax
80103bc1:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103bc4:	89 01                	mov    %eax,(%ecx)
  *np->tf = *curproc->tf;
80103bc6:	8b 79 1c             	mov    0x1c(%ecx),%edi
  np->parent = curproc;
80103bc9:	89 c8                	mov    %ecx,%eax
80103bcb:	89 59 18             	mov    %ebx,0x18(%ecx)
  *np->tf = *curproc->tf;
80103bce:	b9 13 00 00 00       	mov    $0x13,%ecx
80103bd3:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103bd6:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103bd8:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103bda:	8b 40 1c             	mov    0x1c(%eax),%eax
80103bdd:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80103be4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[i])
80103be8:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
80103bec:	85 c0                	test   %eax,%eax
80103bee:	74 13                	je     80103c03 <fork+0x93>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103bf0:	83 ec 0c             	sub    $0xc,%esp
80103bf3:	50                   	push   %eax
80103bf4:	e8 77 d2 ff ff       	call   80100e70 <filedup>
80103bf9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103bfc:	83 c4 10             	add    $0x10,%esp
80103bff:	89 44 b2 2c          	mov    %eax,0x2c(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
80103c03:	83 c6 01             	add    $0x1,%esi
80103c06:	83 fe 10             	cmp    $0x10,%esi
80103c09:	75 dd                	jne    80103be8 <fork+0x78>
  np->cwd = idup(curproc->cwd);
80103c0b:	83 ec 0c             	sub    $0xc,%esp
80103c0e:	ff 73 6c             	pushl  0x6c(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103c11:	83 c3 70             	add    $0x70,%ebx
  np->cwd = idup(curproc->cwd);
80103c14:	e8 17 db ff ff       	call   80101730 <idup>
80103c19:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103c1c:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103c1f:	89 47 6c             	mov    %eax,0x6c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103c22:	8d 47 70             	lea    0x70(%edi),%eax
80103c25:	6a 10                	push   $0x10
80103c27:	53                   	push   %ebx
80103c28:	50                   	push   %eax
80103c29:	e8 12 0f 00 00       	call   80104b40 <safestrcpy>
  pid = np->pid;
80103c2e:	8b 5f 14             	mov    0x14(%edi),%ebx
  acquire(&ptable.lock);
80103c31:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
80103c38:	e8 33 0c 00 00       	call   80104870 <acquire>
  np->state = RUNNABLE;
80103c3d:	c7 47 10 03 00 00 00 	movl   $0x3,0x10(%edi)
  release(&ptable.lock);
80103c44:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
80103c4b:	e8 e0 0c 00 00       	call   80104930 <release>
  return pid;
...
80103c6d:	e8 fe e7 ff ff       	call   80102470 <kfree>
    np->kstack = 0;
80103c72:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    return -1;
80103c79:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103c7c:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return -1;
...
80103c9a:	83 ec 2c             	sub    $0x2c,%esp
  pushcli();
80103c9d:	e8 ce 0a 00 00       	call   80104770 <pushcli>
  c = mycpu();
80103ca2:	e8 49 fc ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103ca7:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cad:	e8 0e 0b 00 00       	call   801047c0 <popcli>
  if(((uint)stack % PGSIZE) != 0)
80103cb2:	f7 45 14 ff 0f 00 00 	testl  $0xfff,0x14(%ebp)
80103cb9:	0f 85 16 01 00 00    	jne    80103dd5 <clone+0x145>
  if((curproc->sz - (uint)stack) < PGSIZE)
80103cbf:	8b 03                	mov    (%ebx),%eax
80103cc1:	2b 45 14             	sub    0x14(%ebp),%eax
80103cc4:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80103cc9:	0f 86 06 01 00 00    	jbe    80103dd5 <clone+0x145>
  if((np = allocproc()) == 0)
80103ccf:	e8 bc fa ff ff       	call   80103790 <allocproc>
80103cd4:	89 c2                	mov    %eax,%edx
80103cd6:	85 c0                	test   %eax,%eax
80103cd8:	0f 84 f7 00 00 00    	je     80103dd5 <clone+0x145>
  np->pgdir = curproc->pgdir;
80103cde:	8b 43 04             	mov    0x4(%ebx),%eax
  if (copyout(np->pgdir, stack_pointer, user_stack, 12) < 0)
80103ce1:	89 55 d0             	mov    %edx,-0x30(%ebp)
  np->pgdir = curproc->pgdir;
80103ce4:	89 42 04             	mov    %eax,0x4(%edx)
  user_stack[1] = (uint)arg1;
80103ce7:	8b 45 0c             	mov    0xc(%ebp),%eax
  if (copyout(np->pgdir, stack_pointer, user_stack, 12) < 0)
80103cea:	6a 0c                	push   $0xc
  user_stack[1] = (uint)arg1;
80103cec:	89 45 e0             	mov    %eax,-0x20(%ebp)
  user_stack[2] = (uint)arg2;
80103cef:	8b 45 10             	mov    0x10(%ebp),%eax
  user_stack[0] = 0xffffffff;
80103cf2:	c7 45 dc ff ff ff ff 	movl   $0xffffffff,-0x24(%ebp)
  user_stack[2] = (uint)arg2;
80103cf9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  stack_pointer -= 12;
80103cfc:	8b 45 14             	mov    0x14(%ebp),%eax
80103cff:	05 f4 0f 00 00       	add    $0xff4,%eax
80103d04:	89 c1                	mov    %eax,%ecx
  if (copyout(np->pgdir, stack_pointer, user_stack, 12) < 0)
80103d06:	8d 45 dc             	lea    -0x24(%ebp),%eax
80103d09:	50                   	push   %eax
80103d0a:	51                   	push   %ecx
80103d0b:	ff 72 04             	pushl  0x4(%edx)
80103d0e:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
80103d11:	e8 0a 37 00 00       	call   80107420 <copyout>
80103d16:	83 c4 10             	add    $0x10,%esp
80103d19:	85 c0                	test   %eax,%eax
80103d1b:	0f 88 b4 00 00 00    	js     80103dd5 <clone+0x145>
  np->sz = curproc->sz;
80103d21:	8b 03                	mov    (%ebx),%eax
80103d23:	8b 55 d0             	mov    -0x30(%ebp),%edx
  *np->tf = *curproc->tf;
80103d26:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->sz = curproc->sz;
80103d2b:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
80103d2d:	8b 7a 1c             	mov    0x1c(%edx),%edi
  np->parent = curproc;
80103d30:	89 5a 18             	mov    %ebx,0x18(%edx)
  *np->tf = *curproc->tf;
80103d33:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103d36:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tf->esp = (uint)stack_pointer;
80103d38:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
  for(i = 0; i < NOFILE; i++)
80103d3b:	31 f6                	xor    %esi,%esi
80103d3d:	89 d7                	mov    %edx,%edi
  np->tf->eax = 0;
80103d3f:	8b 42 1c             	mov    0x1c(%edx),%eax
80103d42:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  np->tf->esp = (uint)stack_pointer;
80103d49:	8b 42 1c             	mov    0x1c(%edx),%eax
80103d4c:	89 48 44             	mov    %ecx,0x44(%eax)
  np->tf->eip = (uint)fcn;
80103d4f:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103d52:	8b 42 1c             	mov    0x1c(%edx),%eax
80103d55:	89 48 38             	mov    %ecx,0x38(%eax)
  np->threadstack = stack;
80103d58:	8b 45 14             	mov    0x14(%ebp),%eax
80103d5b:	89 42 0c             	mov    %eax,0xc(%edx)
  for(i = 0; i < NOFILE; i++)
80103d5e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[i])
80103d60:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
80103d64:	85 c0                	test   %eax,%eax
80103d66:	74 10                	je     80103d78 <clone+0xe8>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103d68:	83 ec 0c             	sub    $0xc,%esp
80103d6b:	50                   	push   %eax
80103d6c:	e8 ff d0 ff ff       	call   80100e70 <filedup>
80103d71:	83 c4 10             	add    $0x10,%esp
80103d74:	89 44 b7 2c          	mov    %eax,0x2c(%edi,%esi,4)
  for(i = 0; i < NOFILE; i++)
80103d78:	83 c6 01             	add    $0x1,%esi
80103d7b:	83 fe 10             	cmp    $0x10,%esi
80103d7e:	75 e0                	jne    80103d60 <clone+0xd0>
  np->cwd = idup(curproc->cwd);
80103d80:	83 ec 0c             	sub    $0xc,%esp
80103d83:	ff 73 6c             	pushl  0x6c(%ebx)
80103d86:	89 7d d4             	mov    %edi,-0x2c(%ebp)
80103d89:	e8 a2 d9 ff ff       	call   80101730 <idup>
80103d8e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d91:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103d94:	89 42 6c             	mov    %eax,0x6c(%edx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d97:	8d 43 70             	lea    0x70(%ebx),%eax
  pid = np->pid;
80103d9a:	8b 72 14             	mov    0x14(%edx),%esi
  np->state = RUNNABLE;
80103d9d:	c7 42 10 03 00 00 00 	movl   $0x3,0x10(%edx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103da4:	6a 10                	push   $0x10
80103da6:	50                   	push   %eax
80103da7:	8d 42 70             	lea    0x70(%edx),%eax
80103daa:	50                   	push   %eax
80103dab:	e8 90 0d 00 00       	call   80104b40 <safestrcpy>
  curproc->thread_count++;
80103db0:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
  np->thread_count = curproc->thread_count;
80103db6:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  return pid;
80103db9:	83 c4 10             	add    $0x10,%esp
  curproc->thread_count++;
80103dbc:	83 c0 01             	add    $0x1,%eax
80103dbf:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
  np->thread_count = curproc->thread_count;
80103dc5:	89 82 80 00 00 00    	mov    %eax,0x80(%edx)
}
...
80103dd4:	c3                   	ret    
    return -1;
80103dd5:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103dda:	eb ef                	jmp    80103dcb <clone+0x13b>
...
80103e09:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e0c:	bb 94 2d 11 80       	mov    $0x80112d94,%ebx
    acquire(&ptable.lock);
80103e11:	68 60 2d 11 80       	push   $0x80112d60
80103e16:	e8 55 0a 00 00       	call   80104870 <acquire>
80103e1b:	83 c4 10             	add    $0x10,%esp
80103e1e:	66 90                	xchg   %ax,%ax
      if(p->state != RUNNABLE)
80103e20:	83 7b 10 03          	cmpl   $0x3,0x10(%ebx)
...
80103e30:	e8 ab 2f 00 00       	call   80106de0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103e35:	58                   	pop    %eax
80103e36:	5a                   	pop    %edx
80103e37:	ff 73 20             	pushl  0x20(%ebx)
80103e3a:	57                   	push   %edi
      p->state = RUNNING;
80103e3b:	c7 43 10 04 00 00 00 	movl   $0x4,0x10(%ebx)
      swtch(&(c->scheduler), p->context);
80103e42:	e8 5c 0d 00 00       	call   80104ba3 <swtch>
      switchkvm();
80103e47:	e8 74 2f 00 00       	call   80106dc0 <switchkvm>
      c->proc = 0;
...
80103e5f:	81 fb 94 4e 11 80    	cmp    $0x80114e94,%ebx
80103e65:	75 b9                	jne    80103e20 <scheduler+0x40>
    release(&ptable.lock);
80103e67:	83 ec 0c             	sub    $0xc,%esp
80103e6a:	68 60 2d 11 80       	push   $0x80112d60
80103e6f:	e8 bc 0a 00 00       	call   80104930 <release>
    sti();
...
80103e88:	53                   	push   %ebx
  pushcli();
80103e89:	e8 e2 08 00 00       	call   80104770 <pushcli>
  c = mycpu();
80103e8e:	e8 5d fa ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103e93:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e99:	e8 22 09 00 00       	call   801047c0 <popcli>
  if(!holding(&ptable.lock))
80103e9e:	83 ec 0c             	sub    $0xc,%esp
80103ea1:	68 60 2d 11 80       	push   $0x80112d60
80103ea6:	e8 75 09 00 00       	call   80104820 <holding>
...
80103ebe:	75 68                	jne    80103f28 <sched+0xa8>
  if(p->state == RUNNING)
80103ec0:	83 7b 10 04          	cmpl   $0x4,0x10(%ebx)
...
80103ed2:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
...
80103ee7:	e8 b7 0c 00 00       	call   80104ba3 <swtch>
  mycpu()->intena = intena;
...
80103f4a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103f4d:	e8 1e 08 00 00       	call   80104770 <pushcli>
  c = mycpu();
80103f52:	e8 99 f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103f57:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f5d:	e8 5e 08 00 00       	call   801047c0 <popcli>
  if(curproc == initproc)
80103f62:	8d 5e 2c             	lea    0x2c(%esi),%ebx
80103f65:	8d 7e 6c             	lea    0x6c(%esi),%edi
...
80103f9f:	ff 76 6c             	pushl  0x6c(%esi)
80103fa2:	e8 e9 d8 ff ff       	call   80101890 <iput>
  end_op();
80103fa7:	e8 f4 ed ff ff       	call   80102da0 <end_op>
  curproc->cwd = 0;
80103fac:	c7 46 6c 00 00 00 00 	movl   $0x0,0x6c(%esi)
  acquire(&ptable.lock);
80103fb3:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
80103fba:	e8 b1 08 00 00       	call   80104870 <acquire>
  wakeup1(curproc->parent);
80103fbf:	8b 56 18             	mov    0x18(%esi),%edx
...
8010408b:	68 60 2d 11 80       	push   $0x80112d60
80104090:	e8 db 07 00 00       	call   80104870 <acquire>
  pushcli();
80104095:	e8 d6 06 00 00       	call   80104770 <pushcli>
  c = mycpu();
8010409a:	e8 51 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010409f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040a5:	e8 16 07 00 00       	call   801047c0 <popcli>
  myproc()->state = RUNNABLE;
801040aa:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  sched();
801040b1:	e8 ca fd ff ff       	call   80103e80 <sched>
  release(&ptable.lock);
801040b6:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
801040bd:	e8 6e 08 00 00       	call   80104930 <release>
}
...
801040e0:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801040e3:	e8 88 06 00 00       	call   80104770 <pushcli>
  c = mycpu();
801040e8:	e8 03 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801040ed:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040f3:	e8 c8 06 00 00       	call   801047c0 <popcli>
  if(p == 0)
...
80104104:	81 fe 60 2d 11 80    	cmp    $0x80112d60,%esi
8010410a:	74 4c                	je     80104158 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
8010410c:	83 ec 0c             	sub    $0xc,%esp
8010410f:	68 60 2d 11 80       	push   $0x80112d60
80104114:	e8 57 07 00 00       	call   80104870 <acquire>
    release(lk);
80104119:	89 34 24             	mov    %esi,(%esp)
8010411c:	e8 0f 08 00 00       	call   80104930 <release>
  p->chan = chan;
80104121:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80104124:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
8010412b:	e8 50 fd ff ff       	call   80103e80 <sched>
  p->chan = 0;
80104130:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
80104137:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
...
8010414f:	5d                   	pop    %ebp
    acquire(lk);
80104150:	e9 1b 07 00 00       	jmp    80104870 <acquire>
80104155:	8d 76 00             	lea    0x0(%esi),%esi
  p->chan = chan;
80104158:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
8010415b:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
...
80104179:	68 a2 7a 10 80       	push   $0x80107aa2
8010417e:	e8 0d c2 ff ff       	call   80100390 <panic>
    panic("sleep");
80104183:	83 ec 0c             	sub    $0xc,%esp
80104186:	68 9c 7a 10 80       	push   $0x80107a9c
...
80104198:	53                   	push   %ebx
  pushcli();
80104199:	e8 d2 05 00 00       	call   80104770 <pushcli>
  c = mycpu();
8010419e:	e8 4d f7 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801041a3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801041a9:	e8 12 06 00 00       	call   801047c0 <popcli>
  acquire(&ptable.lock);
801041ae:	83 ec 0c             	sub    $0xc,%esp
801041b1:	68 60 2d 11 80       	push   $0x80112d60
801041b6:	e8 b5 06 00 00       	call   80104870 <acquire>
801041bb:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801041be:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801041c0:	bb 94 2d 11 80       	mov    $0x80112d94,%ebx
...
801041d6:	81 fb 94 4e 11 80    	cmp    $0x80114e94,%ebx
801041dc:	74 26                	je     80104204 <join+0x74>
      if(p->parent != cp || p->pgdir != cp->pgdir)
801041de:	39 73 18             	cmp    %esi,0x18(%ebx)
...
801041e9:	75 e5                	jne    801041d0 <join+0x40>
      if(p->state == ZOMBIE){        
801041eb:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
801041ef:	74 3f                	je     80104230 <join+0xa0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801041f1:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
801041f7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801041fc:	81 fb 94 4e 11 80    	cmp    $0x80114e94,%ebx
80104202:	75 da                	jne    801041de <join+0x4e>
    if(!havekids || cp->killed){     
80104204:	85 c0                	test   %eax,%eax
80104206:	0f 84 97 00 00 00    	je     801042a3 <join+0x113>
8010420c:	8b 46 28             	mov    0x28(%esi),%eax
8010420f:	85 c0                	test   %eax,%eax
80104211:	0f 85 8c 00 00 00    	jne    801042a3 <join+0x113>
    sleep(cp, &ptable.lock);  //DOC: wait-sleep
80104217:	83 ec 08             	sub    $0x8,%esp
8010421a:	68 60 2d 11 80       	push   $0x80112d60
8010421f:	56                   	push   %esi
80104220:	e8 ab fe ff ff       	call   801040d0 <sleep>
    havekids = 0;
80104225:	83 c4 10             	add    $0x10,%esp
80104228:	eb 94                	jmp    801041be <join+0x2e>
8010422a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        cp->thread_count--;               
80104230:	83 ae 80 00 00 00 01 	subl   $0x1,0x80(%esi)
        *stack = p->threadstack;
80104237:	8b 45 08             	mov    0x8(%ebp),%eax
        kfree(p->kstack);
8010423a:	83 ec 0c             	sub    $0xc,%esp
        *stack = p->threadstack;
8010423d:	8b 53 0c             	mov    0xc(%ebx),%edx
80104240:	89 10                	mov    %edx,(%eax)
        void *sa = (void *)p->parent->tf->esp + 7 * sizeof(void*);
80104242:	8b 43 18             	mov    0x18(%ebx),%eax
        pid = p->pid;    
80104245:	8b 73 14             	mov    0x14(%ebx),%esi
        void *sa = (void *)p->parent->tf->esp + 7 * sizeof(void*);
80104248:	8b 40 1c             	mov    0x1c(%eax),%eax
        *(uint *)sa += 3 * sizeof(void *) - PGSIZE;
8010424b:	8b 50 44             	mov    0x44(%eax),%edx
        *(uint *)sa = p->tf->ebp;
8010424e:	8b 43 1c             	mov    0x1c(%ebx),%eax
        *(uint *)sa += 3 * sizeof(void *) - PGSIZE;
80104251:	8b 40 08             	mov    0x8(%eax),%eax
80104254:	2d f4 0f 00 00       	sub    $0xff4,%eax
80104259:	89 42 1c             	mov    %eax,0x1c(%edx)
        kfree(p->kstack);
8010425c:	ff 73 08             	pushl  0x8(%ebx)
8010425f:	e8 0c e2 ff ff       	call   80102470 <kfree>
        release(&ptable.lock);
80104264:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
        p->kstack = 0;
8010426b:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        p->pid = 0;
80104272:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80104279:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
80104280:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80104284:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;       
8010428b:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
80104292:	e8 99 06 00 00       	call   80104930 <release>
        return pid;
80104297:	83 c4 10             	add    $0x10,%esp
}
8010429a:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010429d:	89 f0                	mov    %esi,%eax
8010429f:	5b                   	pop    %ebx
801042a0:	5e                   	pop    %esi
801042a1:	5d                   	pop    %ebp
801042a2:	c3                   	ret    
...
801042a3:	83 ec 0c             	sub    $0xc,%esp
      return -1;
801042a6:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801042ab:	68 60 2d 11 80       	push   $0x80112d60
801042b0:	e8 7b 06 00 00       	call   80104930 <release>
      return -1;
801042b5:	83 c4 10             	add    $0x10,%esp
801042b8:	eb e0                	jmp    8010429a <join+0x10a>
...
801042c8:	53                   	push   %ebx
  pushcli();
801042c9:	e8 a2 04 00 00       	call   80104770 <pushcli>
  c = mycpu();
801042ce:	e8 1d f6 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801042d3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801042d9:	e8 e2 04 00 00       	call   801047c0 <popcli>
  acquire(&ptable.lock);
801042de:	83 ec 0c             	sub    $0xc,%esp
801042e1:	68 60 2d 11 80       	push   $0x80112d60
801042e6:	e8 85 05 00 00       	call   80104870 <acquire>
801042eb:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801042ee:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042f0:	bb 94 2d 11 80       	mov    $0x80112d94,%ebx
801042f5:	eb 1b                	jmp    80104312 <wait+0x52>
801042f7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801042fe:	66 90                	xchg   %ax,%ax
80104300:	81 c3 84 00 00 00    	add    $0x84,%ebx
80104306:	81 fb 94 4e 11 80    	cmp    $0x80114e94,%ebx
8010430c:	0f 84 7e 00 00 00    	je     80104390 <wait+0xd0>
      if(p->parent != curproc || curproc->pgdir == p->pgdir)
80104312:	39 73 18             	cmp    %esi,0x18(%ebx)
80104315:	75 e9                	jne    80104300 <wait+0x40>
80104317:	8b 53 04             	mov    0x4(%ebx),%edx
8010431a:	39 56 04             	cmp    %edx,0x4(%esi)
8010431d:	74 e1                	je     80104300 <wait+0x40>
      if(p->state == ZOMBIE && p->thread_count == 0){
8010431f:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
      havekids = 1;
80104323:	b8 01 00 00 00       	mov    $0x1,%eax
      if(p->state == ZOMBIE && p->thread_count == 0){
80104328:	75 d6                	jne    80104300 <wait+0x40>
8010432a:	8b 8b 80 00 00 00    	mov    0x80(%ebx),%ecx
80104330:	85 c9                	test   %ecx,%ecx
80104332:	75 cc                	jne    80104300 <wait+0x40>
        kfree(p->kstack);
80104334:	83 ec 0c             	sub    $0xc,%esp
80104337:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
8010433a:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
8010433d:	e8 2e e1 ff ff       	call   80102470 <kfree>
        freevm(p->pgdir);
80104342:	5a                   	pop    %edx
80104343:	ff 73 04             	pushl  0x4(%ebx)
        p->kstack = 0;
80104346:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
8010434d:	e8 4e 2e 00 00       	call   801071a0 <freevm>
        p->pid = 0;
80104352:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80104359:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
80104360:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80104364:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
8010436b:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
80104372:	c7 04 24 60 2d 11 80 	movl   $0x80112d60,(%esp)
80104379:	e8 b2 05 00 00       	call   80104930 <release>
        return pid;
8010437e:	83 c4 10             	add    $0x10,%esp
}
80104381:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104384:	89 f0                	mov    %esi,%eax
80104386:	5b                   	pop    %ebx
80104387:	5e                   	pop    %esi
80104388:	5d                   	pop    %ebp
80104389:	c3                   	ret    
...
80104392:	74 1d                	je     801043b1 <wait+0xf1>
80104394:	8b 46 28             	mov    0x28(%esi),%eax
80104397:	85 c0                	test   %eax,%eax
80104399:	75 16                	jne    801043b1 <wait+0xf1>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
8010439b:	83 ec 08             	sub    $0x8,%esp
8010439e:	68 60 2d 11 80       	push   $0x80112d60
801043a3:	56                   	push   %esi
801043a4:	e8 27 fd ff ff       	call   801040d0 <sleep>
    havekids = 0;
801043a9:	83 c4 10             	add    $0x10,%esp
801043ac:	e9 3d ff ff ff       	jmp    801042ee <wait+0x2e>
      release(&ptable.lock);
801043b1:	83 ec 0c             	sub    $0xc,%esp
      return -1;
801043b4:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801043b9:	68 60 2d 11 80       	push   $0x80112d60
801043be:	e8 6d 05 00 00       	call   80104930 <release>
      return -1;
801043c3:	83 c4 10             	add    $0x10,%esp
}
801043c6:	8d 65 f8             	lea    -0x8(%ebp),%esp
801043c9:	89 f0                	mov    %esi,%eax
801043cb:	5b                   	pop    %ebx
801043cc:	5e                   	pop    %esi
801043cd:	5d                   	pop    %ebp
801043ce:	c3                   	ret    
...
801043db:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
801043de:	68 60 2d 11 80       	push   $0x80112d60
801043e3:	e8 88 04 00 00       	call   80104870 <acquire>
801043e8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801043eb:	b8 94 2d 11 80       	mov    $0x80112d94,%eax
801043f0:	eb 12                	jmp    80104404 <wakeup+0x34>
801043f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801043f8:	05 84 00 00 00       	add    $0x84,%eax
801043fd:	3d 94 4e 11 80       	cmp    $0x80114e94,%eax
80104402:	74 1e                	je     80104422 <wakeup+0x52>
    if(p->state == SLEEPING && p->chan == chan)
80104404:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80104408:	75 ee                	jne    801043f8 <wakeup+0x28>
8010440a:	3b 58 24             	cmp    0x24(%eax),%ebx
8010440d:	75 e9                	jne    801043f8 <wakeup+0x28>
      p->state = RUNNABLE;
8010440f:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104416:	05 84 00 00 00       	add    $0x84,%eax
8010441b:	3d 94 4e 11 80       	cmp    $0x80114e94,%eax
80104420:	75 e2                	jne    80104404 <wakeup+0x34>
  wakeup1(chan);
  release(&ptable.lock);
80104422:	c7 45 08 60 2d 11 80 	movl   $0x80112d60,0x8(%ebp)
}
80104429:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010442c:	c9                   	leave  
  release(&ptable.lock);
8010442d:	e9 fe 04 00 00       	jmp    80104930 <release>
...
8010444b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010444e:	68 60 2d 11 80       	push   $0x80112d60
80104453:	e8 18 04 00 00       	call   80104870 <acquire>
80104458:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010445b:	b8 94 2d 11 80       	mov    $0x80112d94,%eax
80104460:	eb 12                	jmp    80104474 <kill+0x34>
80104462:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104468:	05 84 00 00 00       	add    $0x84,%eax
8010446d:	3d 94 4e 11 80       	cmp    $0x80114e94,%eax
80104472:	74 34                	je     801044a8 <kill+0x68>
    if(p->pid == pid){
80104474:	39 58 14             	cmp    %ebx,0x14(%eax)
80104477:	75 ef                	jne    80104468 <kill+0x28>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104479:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
      p->killed = 1;
8010447d:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
80104484:	75 07                	jne    8010448d <kill+0x4d>
        p->state = RUNNABLE;
80104486:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      release(&ptable.lock);
8010448d:	83 ec 0c             	sub    $0xc,%esp
80104490:	68 60 2d 11 80       	push   $0x80112d60
80104495:	e8 96 04 00 00       	call   80104930 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801044ab:	68 60 2d 11 80       	push   $0x80112d60
801044b0:	e8 7b 04 00 00       	call   80104930 <release>
}
...
801044d9:	8d 75 e8             	lea    -0x18(%ebp),%esi
801044dc:	53                   	push   %ebx
801044dd:	bb 04 2e 11 80       	mov    $0x80112e04,%ebx
801044e2:	83 ec 3c             	sub    $0x3c,%esp
801044e5:	eb 2b                	jmp    80104512 <procdump+0x42>
...
801044f3:	68 3f 7e 10 80       	push   $0x80107e3f
801044f8:	e8 b3 c1 ff ff       	call   801006b0 <cprintf>
801044fd:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104500:	81 c3 84 00 00 00    	add    $0x84,%ebx
80104506:	81 fb 04 4f 11 80    	cmp    $0x80114f04,%ebx
8010450c:	0f 84 8e 00 00 00    	je     801045a0 <procdump+0xd0>
    if(p->state == UNUSED)
80104512:	8b 43 a0             	mov    -0x60(%ebx),%eax
80104515:	85 c0                	test   %eax,%eax
80104517:	74 e7                	je     80104500 <procdump+0x30>
      state = "???";
80104519:	ba b3 7a 10 80       	mov    $0x80107ab3,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010451e:	83 f8 05             	cmp    $0x5,%eax
80104521:	77 11                	ja     80104534 <procdump+0x64>
80104523:	8b 14 85 14 7b 10 80 	mov    -0x7fef84ec(,%eax,4),%edx
      state = "???";
8010452a:	b8 b3 7a 10 80       	mov    $0x80107ab3,%eax
8010452f:	85 d2                	test   %edx,%edx
80104531:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80104534:	53                   	push   %ebx
80104535:	52                   	push   %edx
80104536:	ff 73 a4             	pushl  -0x5c(%ebx)
80104539:	68 b7 7a 10 80       	push   $0x80107ab7
8010453e:	e8 6d c1 ff ff       	call   801006b0 <cprintf>
    if(p->state == SLEEPING){
80104543:	83 c4 10             	add    $0x10,%esp
80104546:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
8010454a:	75 a4                	jne    801044f0 <procdump+0x20>
      getcallerpcs((uint*)p->context->ebp+2, pc);
8010454c:	83 ec 08             	sub    $0x8,%esp
8010454f:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104552:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104555:	50                   	push   %eax
80104556:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104559:	8b 40 0c             	mov    0xc(%eax),%eax
8010455c:	83 c0 08             	add    $0x8,%eax
8010455f:	50                   	push   %eax
80104560:	e8 ab 01 00 00       	call   80104710 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104574:	0f 84 76 ff ff ff    	je     801044f0 <procdump+0x20>
        cprintf(" %p", pc[i]);
8010457a:	83 ec 08             	sub    $0x8,%esp
8010457d:	83 c7 04             	add    $0x4,%edi
80104580:	52                   	push   %edx
80104581:	68 01 75 10 80       	push   $0x80107501
80104586:	e8 25 c1 ff ff       	call   801006b0 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
8010458b:	83 c4 10             	add    $0x10,%esp
8010458e:	39 fe                	cmp    %edi,%esi
80104590:	75 de                	jne    80104570 <procdump+0xa0>
80104592:	e9 59 ff ff ff       	jmp    801044f0 <procdump+0x20>
...
801045be:	68 2c 7b 10 80       	push   $0x80107b2c
801045c3:	8d 43 04             	lea    0x4(%ebx),%eax
801045c6:	50                   	push   %eax
801045c7:	e8 24 01 00 00       	call   801046f0 <initlock>
  lk->name = name;
...
801045d5:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
801045d8:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
801045df:	89 43 38             	mov    %eax,0x38(%ebx)
}
...
80104603:	e8 68 02 00 00       	call   80104870 <acquire>
  while (lk->locked) {
80104608:	8b 13                	mov    (%ebx),%edx
8010460a:	83 c4 10             	add    $0x10,%esp
8010460d:	85 d2                	test   %edx,%edx
8010460f:	74 1a                	je     8010462b <acquiresleep+0x3b>
80104611:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
80104618:	83 ec 08             	sub    $0x8,%esp
8010461b:	56                   	push   %esi
8010461c:	53                   	push   %ebx
8010461d:	e8 ae fa ff ff       	call   801040d0 <sleep>
  while (lk->locked) {
80104622:	8b 03                	mov    (%ebx),%eax
80104624:	83 c4 10             	add    $0x10,%esp
80104627:	85 c0                	test   %eax,%eax
80104629:	75 ed                	jne    80104618 <acquiresleep+0x28>
  }
  lk->locked = 1;
8010462b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104631:	e8 4a f3 ff ff       	call   80103980 <myproc>
80104636:	8b 40 14             	mov    0x14(%eax),%eax
80104639:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
8010463c:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80104644:	5d                   	pop    %ebp
  release(&lk->lk);
80104645:	e9 e6 02 00 00       	jmp    80104930 <release>
...
80104663:	e8 08 02 00 00       	call   80104870 <acquire>
  lk->locked = 0;
80104668:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
8010466e:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80104675:	89 1c 24             	mov    %ebx,(%esp)
80104678:	e8 53 fd ff ff       	call   801043d0 <wakeup>
  release(&lk->lk);
8010467d:	89 75 08             	mov    %esi,0x8(%ebp)
...
80104688:	5d                   	pop    %ebp
  release(&lk->lk);
80104689:	e9 a2 02 00 00       	jmp    80104930 <release>
...
8010469c:	83 ec 18             	sub    $0x18,%esp
8010469f:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
801046a2:	8d 73 04             	lea    0x4(%ebx),%esi
801046a5:	56                   	push   %esi
801046a6:	e8 c5 01 00 00       	call   80104870 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
801046ab:	8b 03                	mov    (%ebx),%eax
801046ad:	83 c4 10             	add    $0x10,%esp
801046b0:	85 c0                	test   %eax,%eax
801046b2:	75 1c                	jne    801046d0 <holdingsleep+0x40>
  release(&lk->lk);
801046b4:	83 ec 0c             	sub    $0xc,%esp
801046b7:	56                   	push   %esi
801046b8:	e8 73 02 00 00       	call   80104930 <release>
  return r;
}
801046bd:	8d 65 f4             	lea    -0xc(%ebp),%esp
801046c0:	89 f8                	mov    %edi,%eax
801046c2:	5b                   	pop    %ebx
801046c3:	5e                   	pop    %esi
801046c4:	5f                   	pop    %edi
801046c5:	5d                   	pop    %ebp
...
801046d3:	e8 a8 f2 ff ff       	call   80103980 <myproc>
801046d8:	39 58 14             	cmp    %ebx,0x14(%eax)
801046db:	0f 94 c0             	sete   %al
801046de:	0f b6 c0             	movzbl %al,%eax
801046e1:	89 c7                	mov    %eax,%edi
801046e3:	eb cf                	jmp    801046b4 <holdingsleep+0x24>
...
801046fa:	8b 55 0c             	mov    0xc(%ebp),%edx
  lk->locked = 0;
801046fd:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->name = name;
80104703:	89 50 04             	mov    %edx,0x4(%eax)
  lk->cpu = 0;
80104706:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
8010470d:	5d                   	pop    %ebp
8010470e:	c3                   	ret    
8010470f:	90                   	nop
...
{
8010471d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ebp = (uint*)v - 2;
80104720:	83 e8 08             	sub    $0x8,%eax
  for(i = 0; i < 10; i++){
...
80104734:	77 1a                	ja     80104750 <getcallerpcs+0x40>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104736:	8b 58 04             	mov    0x4(%eax),%ebx
80104739:	89 1c 91             	mov    %ebx,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
8010473c:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
8010473f:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104741:	83 fa 0a             	cmp    $0xa,%edx
80104744:	75 e2                	jne    80104728 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
80104749:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
80104750:	8d 04 91             	lea    (%ecx,%edx,4),%eax
80104753:	8d 51 28             	lea    0x28(%ecx),%edx
...
8010476b:	75 f3                	jne    80104760 <getcallerpcs+0x50>
}
8010476d:	5b                   	pop    %ebx
8010476e:	5d                   	pop    %ebp
8010476f:	c3                   	ret    
...
8010477d:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010477e:	e8 6d f1 ff ff       	call   801038f0 <mycpu>
80104783:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104789:	85 c0                	test   %eax,%eax
8010478b:	74 13                	je     801047a0 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
8010478d:	e8 5e f1 ff ff       	call   801038f0 <mycpu>
80104792:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
801047b1:	eb da                	jmp    8010478d <pushcli+0x1d>
...
801047cb:	58                   	pop    %eax
  if(readeflags()&FL_IF)
801047cc:	f6 c4 02             	test   $0x2,%ah
801047cf:	75 31                	jne    80104802 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
801047d1:	e8 1a f1 ff ff       	call   801038f0 <mycpu>
801047d6:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
801047dd:	78 30                	js     8010480f <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
801047df:	e8 0c f1 ff ff       	call   801038f0 <mycpu>
801047e4:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
801047ea:	85 d2                	test   %edx,%edx
801047ec:	74 02                	je     801047f0 <popcli+0x30>
    sti();
}
801047ee:	c9                   	leave  
801047ef:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
801047f0:	e8 fb f0 ff ff       	call   801038f0 <mycpu>
801047f5:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
801047fb:	85 c0                	test   %eax,%eax
801047fd:	74 ef                	je     801047ee <popcli+0x2e>
  asm volatile("sti");
801047ff:	fb                   	sti    
}
80104800:	c9                   	leave  
...
80104805:	68 37 7b 10 80       	push   $0x80107b37
8010480a:	e8 81 bb ff ff       	call   80100390 <panic>
    panic("popcli");
8010480f:	83 ec 0c             	sub    $0xc,%esp
80104812:	68 4e 7b 10 80       	push   $0x80107b4e
...
8010482c:	31 db                	xor    %ebx,%ebx
  pushcli();
8010482e:	e8 3d ff ff ff       	call   80104770 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104833:	8b 06                	mov    (%esi),%eax
80104835:	85 c0                	test   %eax,%eax
80104837:	75 0f                	jne    80104848 <holding+0x28>
  popcli();
80104839:	e8 82 ff ff ff       	call   801047c0 <popcli>
}
...
80104879:	e8 f2 fe ff ff       	call   80104770 <pushcli>
  if(holding(lk))
8010487e:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104881:	83 ec 0c             	sub    $0xc,%esp
80104884:	53                   	push   %ebx
80104885:	e8 96 ff ff ff       	call   80104820 <holding>
8010488a:	83 c4 10             	add    $0x10,%esp
8010488d:	85 c0                	test   %eax,%eax
8010488f:	0f 85 7f 00 00 00    	jne    80104914 <acquire+0xa4>
80104895:	89 c6                	mov    %eax,%esi
  asm volatile("lock; xchgl %0, %1" :
80104897:	ba 01 00 00 00       	mov    $0x1,%edx
8010489c:	eb 05                	jmp    801048a3 <acquire+0x33>
...
801048b4:	e8 37 f0 ff ff       	call   801038f0 <mycpu>
801048b9:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
801048bc:	89 e8                	mov    %ebp,%eax
801048be:	66 90                	xchg   %ax,%ax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801048c0:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
801048c6:	81 fa fe ff ff 7f    	cmp    $0x7ffffffe,%edx
801048cc:	77 22                	ja     801048f0 <acquire+0x80>
    pcs[i] = ebp[1];     // saved %eip
801048ce:	8b 50 04             	mov    0x4(%eax),%edx
801048d1:	89 54 b3 0c          	mov    %edx,0xc(%ebx,%esi,4)
  for(i = 0; i < 10; i++){
801048d5:	83 c6 01             	add    $0x1,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
801048d8:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801048da:	83 fe 0a             	cmp    $0xa,%esi
...
801048ed:	8d 76 00             	lea    0x0(%esi),%esi
  for(; i < 10; i++)
801048f0:	8d 44 b3 0c          	lea    0xc(%ebx,%esi,4),%eax
...
80104917:	68 55 7b 10 80       	push   $0x80107b55
...
8010493f:	e8 dc fe ff ff       	call   80104820 <holding>
80104944:	83 c4 10             	add    $0x10,%esp
80104947:	85 c0                	test   %eax,%eax
80104949:	74 22                	je     8010496d <release+0x3d>
  lk->pcs[0] = 0;
8010494b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104952:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104959:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010495e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
80104964:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104967:	c9                   	leave  
  popcli();
80104968:	e9 53 fe ff ff       	jmp    801047c0 <popcli>
    panic("release");
8010496d:	83 ec 0c             	sub    $0xc,%esp
80104970:	68 5d 7b 10 80       	push   $0x80107b5d
80104975:	e8 16 ba ff ff       	call   80100390 <panic>
...
80104994:	09 cf                	or     %ecx,%edi
80104996:	83 e7 03             	and    $0x3,%edi
80104999:	75 25                	jne    801049c0 <memset+0x40>
    c &= 0xFF;
8010499b:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010499e:	c1 e0 18             	shl    $0x18,%eax
801049a1:	89 fb                	mov    %edi,%ebx
801049a3:	c1 e9 02             	shr    $0x2,%ecx
...
801049d8:	8b 75 10             	mov    0x10(%ebp),%esi
...
801049df:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  s2 = v2;
  while(n-- > 0){
801049e2:	85 f6                	test   %esi,%esi
801049e4:	74 2a                	je     80104a10 <memcmp+0x40>
801049e6:	01 c6                	add    %eax,%esi
801049e8:	eb 10                	jmp    801049fa <memcmp+0x2a>
...
80104a2f:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104a32:	39 d6                	cmp    %edx,%esi
80104a34:	73 2a                	jae    80104a60 <memmove+0x40>
80104a36:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80104a39:	39 fa                	cmp    %edi,%edx
80104a3b:	73 23                	jae    80104a60 <memmove+0x40>
80104a3d:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
80104a40:	85 c9                	test   %ecx,%ecx
80104a42:	74 13                	je     80104a57 <memmove+0x37>
80104a44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
80104a48:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
80104a4c:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
80104a4f:	83 e8 01             	sub    $0x1,%eax
80104a52:	83 f8 ff             	cmp    $0xffffffff,%eax
...
80104a5d:	8d 76 00             	lea    0x0(%esi),%esi
    while(n-- > 0)
80104a60:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
80104a63:	89 d7                	mov    %edx,%edi
80104a65:	85 c9                	test   %ecx,%ecx
80104a67:	74 ee                	je     80104a57 <memmove+0x37>
80104a69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
80104a70:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
80104a71:	39 f0                	cmp    %esi,%eax
80104a73:	75 fb                	jne    80104a70 <memmove+0x50>
}
80104a75:	5e                   	pop    %esi
80104a76:	89 d0                	mov    %edx,%eax
80104a78:	5f                   	pop    %edi
80104a79:	5d                   	pop    %ebp
80104a7a:	c3                   	ret    
...
80104a98:	8b 75 10             	mov    0x10(%ebp),%esi
80104a9b:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104a9e:	53                   	push   %ebx
80104a9f:	8b 45 0c             	mov    0xc(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80104aa2:	85 f6                	test   %esi,%esi
80104aa4:	74 32                	je     80104ad8 <strncmp+0x48>
80104aa6:	01 c6                	add    %eax,%esi
80104aa8:	eb 14                	jmp    80104abe <strncmp+0x2e>
80104aaa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104ab0:	38 da                	cmp    %bl,%dl
80104ab2:	75 14                	jne    80104ac8 <strncmp+0x38>
    n--, p++, q++;
80104ab4:	83 c0 01             	add    $0x1,%eax
80104ab7:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104aba:	39 f0                	cmp    %esi,%eax
80104abc:	74 1a                	je     80104ad8 <strncmp+0x48>
80104abe:	0f b6 11             	movzbl (%ecx),%edx
80104ac1:	0f b6 18             	movzbl (%eax),%ebx
80104ac4:	84 d2                	test   %dl,%dl
80104ac6:	75 e8                	jne    80104ab0 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104ac8:	0f b6 c2             	movzbl %dl,%eax
80104acb:	29 d8                	sub    %ebx,%eax
}
80104acd:	5b                   	pop    %ebx
80104ace:	5e                   	pop    %esi
80104acf:	5d                   	pop    %ebp
...
80104aed:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104af0:	89 f2                	mov    %esi,%edx
80104af2:	eb 1b                	jmp    80104b0f <strncpy+0x2f>
80104af4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104af8:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104afc:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104aff:	83 c2 01             	add    $0x1,%edx
80104b02:	0f b6 7f ff          	movzbl -0x1(%edi),%edi
80104b06:	89 f9                	mov    %edi,%ecx
80104b08:	88 4a ff             	mov    %cl,-0x1(%edx)
80104b0b:	84 c9                	test   %cl,%cl
80104b0d:	74 09                	je     80104b18 <strncpy+0x38>
80104b0f:	89 c3                	mov    %eax,%ebx
80104b11:	83 e8 01             	sub    $0x1,%eax
80104b14:	85 db                	test   %ebx,%ebx
80104b16:	7f e0                	jg     80104af8 <strncpy+0x18>
    ;
  while(n-- > 0)
80104b18:	89 d1                	mov    %edx,%ecx
80104b1a:	85 c0                	test   %eax,%eax
80104b1c:	7e 15                	jle    80104b33 <strncpy+0x53>
80104b1e:	66 90                	xchg   %ax,%ax
    *s++ = 0;
80104b20:	83 c1 01             	add    $0x1,%ecx
80104b23:	c6 41 ff 00          	movb   $0x0,-0x1(%ecx)
  while(n-- > 0)
80104b27:	89 c8                	mov    %ecx,%eax
80104b29:	f7 d0                	not    %eax
80104b2b:	01 d0                	add    %edx,%eax
80104b2d:	01 d8                	add    %ebx,%eax
80104b2f:	85 c0                	test   %eax,%eax
80104b31:	7f ed                	jg     80104b20 <strncpy+0x40>
  return os;
}
80104b33:	5b                   	pop    %ebx
80104b34:	89 f0                	mov    %esi,%eax
80104b36:	5e                   	pop    %esi
80104b37:	5f                   	pop    %edi
80104b38:	5d                   	pop    %ebp
80104b39:	c3                   	ret    
...
80104b48:	8b 55 10             	mov    0x10(%ebp),%edx
80104b4b:	8b 75 08             	mov    0x8(%ebp),%esi
...
80104b54:	7e 21                	jle    80104b77 <safestrcpy+0x37>
80104b56:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
80104b5a:	89 f2                	mov    %esi,%edx
80104b5c:	eb 12                	jmp    80104b70 <safestrcpy+0x30>
...
80104b89:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
80104b8c:	80 3a 00             	cmpb   $0x0,(%edx)
80104b8f:	74 10                	je     80104ba1 <strlen+0x21>
80104b91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104b98:	83 c0 01             	add    $0x1,%eax
80104b9b:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80104b9f:	75 f7                	jne    80104b98 <strlen+0x18>
    ;
  return n;
}
80104ba1:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80104ba3:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104ba7:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80104bac:	53                   	push   %ebx
  pushl %esi
80104bad:	56                   	push   %esi
  pushl %edi
80104bae:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
80104baf:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80104bb1:	89 d4                	mov    %edx,%esp
...
80104bcb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104bce:	e8 ad ed ff ff       	call   80103980 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104bd3:	8b 00                	mov    (%eax),%eax
80104bd5:	39 d8                	cmp    %ebx,%eax
80104bd7:	76 17                	jbe    80104bf0 <fetchint+0x30>
80104bd9:	8d 53 04             	lea    0x4(%ebx),%edx
80104bdc:	39 d0                	cmp    %edx,%eax
80104bde:	72 10                	jb     80104bf0 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80104be0:	8b 45 0c             	mov    0xc(%ebp),%eax
80104be3:	8b 13                	mov    (%ebx),%edx
80104be5:	89 10                	mov    %edx,(%eax)
  return 0;
80104be7:	31 c0                	xor    %eax,%eax
}
80104be9:	83 c4 04             	add    $0x4,%esp
80104bec:	5b                   	pop    %ebx
80104bed:	5d                   	pop    %ebp
80104bee:	c3                   	ret    
80104bef:	90                   	nop
...
80104bf5:	eb f2                	jmp    80104be9 <fetchint+0x29>
...
80104c0b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104c0e:	e8 6d ed ff ff       	call   80103980 <myproc>

  if(addr >= curproc->sz)
80104c13:	39 18                	cmp    %ebx,(%eax)
80104c15:	76 31                	jbe    80104c48 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
...
80104c20:	73 26                	jae    80104c48 <fetchstr+0x48>
80104c22:	89 d8                	mov    %ebx,%eax
80104c24:	eb 11                	jmp    80104c37 <fetchstr+0x37>
...
80104c35:	76 11                	jbe    80104c48 <fetchstr+0x48>
    if(*s == 0)
80104c37:	80 38 00             	cmpb   $0x0,(%eax)
80104c3a:	75 f4                	jne    80104c30 <fetchstr+0x30>
      return s - *pp;
  }
  return -1;
}
80104c3c:	83 c4 04             	add    $0x4,%esp
      return s - *pp;
80104c3f:	29 d8                	sub    %ebx,%eax
}
80104c41:	5b                   	pop    %ebx
80104c42:	5d                   	pop    %ebp
80104c43:	c3                   	ret    
80104c44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104c48:	83 c4 04             	add    $0x4,%esp
    return -1;
...
80104c69:	e8 12 ed ff ff       	call   80103980 <myproc>
80104c6e:	8b 55 08             	mov    0x8(%ebp),%edx
80104c71:	8b 40 1c             	mov    0x1c(%eax),%eax
80104c74:	8b 40 44             	mov    0x44(%eax),%eax
80104c77:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104c7a:	e8 01 ed ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c7f:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104c82:	8b 00                	mov    (%eax),%eax
80104c84:	39 c6                	cmp    %eax,%esi
80104c86:	73 18                	jae    80104ca0 <argint+0x40>
80104c88:	8d 53 08             	lea    0x8(%ebx),%edx
80104c8b:	39 d0                	cmp    %edx,%eax
80104c8d:	72 11                	jb     80104ca0 <argint+0x40>
  *ip = *(int*)(addr);
80104c8f:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c92:	8b 53 04             	mov    0x4(%ebx),%edx
80104c95:	89 10                	mov    %edx,(%eax)
  return 0;
...
80104ca0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ca5:	eb f2                	jmp    80104c99 <argint+0x39>
...
80104cbc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104cbf:	e8 bc ec ff ff       	call   80103980 <myproc>
 
  if(argint(n, &i) < 0)
80104cc4:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80104cc7:	89 c6                	mov    %eax,%esi
  if(argint(n, &i) < 0)
80104cc9:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104ccc:	50                   	push   %eax
80104ccd:	ff 75 08             	pushl  0x8(%ebp)
80104cd0:	e8 8b ff ff ff       	call   80104c60 <argint>
    return -1;
...
80104d05:	eb ef                	jmp    80104cf6 <argptr+0x46>
...
80104d17:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
80104d1a:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d1d:	50                   	push   %eax
80104d1e:	ff 75 08             	pushl  0x8(%ebp)
80104d21:	e8 3a ff ff ff       	call   80104c60 <argint>
80104d26:	83 c4 10             	add    $0x10,%esp
80104d29:	85 c0                	test   %eax,%eax
80104d2b:	78 13                	js     80104d40 <argstr+0x30>
    return -1;
  return fetchstr(addr, pp);
80104d2d:	83 ec 08             	sub    $0x8,%esp
80104d30:	ff 75 0c             	pushl  0xc(%ebp)
80104d33:	ff 75 f4             	pushl  -0xc(%ebp)
80104d36:	e8 c5 fe ff ff       	call   80104c00 <fetchstr>
...
80104d58:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104d5b:	e8 20 ec ff ff       	call   80103980 <myproc>
80104d60:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104d62:	8b 40 1c             	mov    0x1c(%eax),%eax
80104d65:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104d68:	8d 50 ff             	lea    -0x1(%eax),%edx
80104d6b:	83 fa 16             	cmp    $0x16,%edx
80104d6e:	77 20                	ja     80104d90 <syscall+0x40>
80104d70:	8b 14 85 a0 7b 10 80 	mov    -0x7fef8460(,%eax,4),%edx
80104d77:	85 d2                	test   %edx,%edx
80104d79:	74 15                	je     80104d90 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104d7b:	ff d2                	call   *%edx
80104d7d:	89 c2                	mov    %eax,%edx
80104d7f:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104d82:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104d95:	ff 73 14             	pushl  0x14(%ebx)
80104d98:	68 65 7b 10 80       	push   $0x80107b65
80104d9d:	e8 0e b9 ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
...
80104dd7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104dda:	e8 71 d2 ff ff       	call   80102050 <nameiparent>
...
80104dfc:	e8 af ce ff ff       	call   80101cb0 <dirlookup>
...
80104e0e:	e8 ed cb ff ff       	call   80101a00 <iunlockput>
    ilock(ip);
80104e13:	89 34 24             	mov    %esi,(%esp)
80104e16:	e8 45 c9 ff ff       	call   80101760 <ilock>
...
80104e44:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104e46:	e8 b5 cb ff ff       	call   80101a00 <iunlockput>
    return 0;
...
80104e6a:	e8 71 c7 ff ff       	call   801015e0 <ialloc>
...
80104e80:	e8 db c8 ff ff       	call   80101760 <ilock>
  ip->major = major;
...
80104ea1:	e8 fa c7 ff ff       	call   801016a0 <iupdate>
...
80104eb3:	ff 76 04             	pushl  0x4(%esi)
80104eb6:	57                   	push   %edi
80104eb7:	53                   	push   %ebx
80104eb8:	e8 b3 d0 ff ff       	call   80101f70 <dirlink>
...
80104ec8:	e8 33 cb ff ff       	call   80101a00 <iunlockput>
  return ip;
...
80104ee9:	e8 b2 c7 ff ff       	call   801016a0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104eee:	83 c4 0c             	add    $0xc,%esp
80104ef1:	ff 76 04             	pushl  0x4(%esi)
80104ef4:	68 1c 7c 10 80       	push   $0x80107c1c
80104ef9:	56                   	push   %esi
80104efa:	e8 71 d0 ff ff       	call   80101f70 <dirlink>
...
80104f0c:	68 1b 7c 10 80       	push   $0x80107c1b
80104f11:	56                   	push   %esi
80104f12:	e8 59 d0 ff ff       	call   80101f70 <dirlink>
...
80104f21:	68 0f 7c 10 80       	push   $0x80107c0f
80104f26:	e8 65 b4 ff ff       	call   80100390 <panic>
...
80104f3f:	68 1e 7c 10 80       	push   $0x80107c1e
80104f44:	e8 47 b4 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104f49:	83 ec 0c             	sub    $0xc,%esp
80104f4c:	68 00 7c 10 80       	push   $0x80107c00
...
80104f64:	89 d6                	mov    %edx,%esi
80104f66:	53                   	push   %ebx
80104f67:	89 c3                	mov    %eax,%ebx
  if(argint(n, &fd) < 0)
...
80104f72:	e8 e9 fc ff ff       	call   80104c60 <argint>
...
80104f84:	e8 f7 e9 ff ff       	call   80103980 <myproc>
80104f89:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104f8c:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104fba:	53                   	push   %ebx
  if(argfd(0, 0, &f) < 0)
80104fbb:	8d 55 f4             	lea    -0xc(%ebp),%edx
{
80104fbe:	83 ec 10             	sub    $0x10,%esp
  if(argfd(0, 0, &f) < 0)
80104fc1:	e8 9a ff ff ff       	call   80104f60 <argfd.constprop.0>
80104fc6:	85 c0                	test   %eax,%eax
80104fc8:	78 1e                	js     80104fe8 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104fca:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
80104fcd:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104fcf:	e8 ac e9 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80104fd4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80104fd8:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80104fdc:	85 d2                	test   %edx,%edx
80104fde:	74 20                	je     80105000 <sys_dup+0x50>
  for(fd = 0; fd < NOFILE; fd++){
80104fe0:	83 c3 01             	add    $0x1,%ebx
80104fe3:	83 fb 10             	cmp    $0x10,%ebx
...
80105059:	e8 52 fc ff ff       	call   80104cb0 <argptr>
8010505e:	83 c4 10             	add    $0x10,%esp
80105061:	85 c0                	test   %eax,%eax
80105063:	78 1b                	js     80105080 <sys_read+0x60>
...
80105071:	e8 7a bf ff ff       	call   80100ff0 <fileread>
...
80105099:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
8010509c:	8d 55 ec             	lea    -0x14(%ebp),%edx
8010509f:	e8 bc fe ff ff       	call   80104f60 <argfd.constprop.0>
801050a4:	85 c0                	test   %eax,%eax
801050a6:	78 48                	js     801050f0 <sys_write+0x60>
801050a8:	83 ec 08             	sub    $0x8,%esp
801050ab:	8d 45 f0             	lea    -0x10(%ebp),%eax
801050ae:	50                   	push   %eax
801050af:	6a 02                	push   $0x2
801050b1:	e8 aa fb ff ff       	call   80104c60 <argint>
801050b6:	83 c4 10             	add    $0x10,%esp
801050b9:	85 c0                	test   %eax,%eax
801050bb:	78 33                	js     801050f0 <sys_write+0x60>
801050bd:	83 ec 04             	sub    $0x4,%esp
801050c0:	8d 45 f4             	lea    -0xc(%ebp),%eax
801050c3:	ff 75 f0             	pushl  -0x10(%ebp)
801050c6:	50                   	push   %eax
801050c7:	6a 01                	push   $0x1
801050c9:	e8 e2 fb ff ff       	call   80104cb0 <argptr>
801050ce:	83 c4 10             	add    $0x10,%esp
801050d1:	85 c0                	test   %eax,%eax
801050d3:	78 1b                	js     801050f0 <sys_write+0x60>
  return filewrite(f, p, n);
801050d5:	83 ec 04             	sub    $0x4,%esp
801050d8:	ff 75 f0             	pushl  -0x10(%ebp)
801050db:	ff 75 f4             	pushl  -0xc(%ebp)
801050de:	ff 75 ec             	pushl  -0x14(%ebp)
801050e1:	e8 aa bf ff ff       	call   80101090 <filewrite>
...
80105107:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
8010510a:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010510d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105110:	e8 4b fe ff ff       	call   80104f60 <argfd.constprop.0>
80105115:	85 c0                	test   %eax,%eax
80105117:	78 27                	js     80105140 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80105119:	e8 62 e8 ff ff       	call   80103980 <myproc>
8010511e:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80105121:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80105124:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
8010512b:	00 
  fileclose(f);
8010512c:	ff 75 f4             	pushl  -0xc(%ebp)
8010512f:	e8 8c bd ff ff       	call   80100ec0 <fileclose>
  return 0;
...
80105159:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
8010515c:	8d 55 f0             	lea    -0x10(%ebp),%edx
8010515f:	e8 fc fd ff ff       	call   80104f60 <argfd.constprop.0>
80105164:	85 c0                	test   %eax,%eax
80105166:	78 30                	js     80105198 <sys_fstat+0x48>
80105168:	83 ec 04             	sub    $0x4,%esp
8010516b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010516e:	6a 14                	push   $0x14
80105170:	50                   	push   %eax
80105171:	6a 01                	push   $0x1
80105173:	e8 38 fb ff ff       	call   80104cb0 <argptr>
80105178:	83 c4 10             	add    $0x10,%esp
8010517b:	85 c0                	test   %eax,%eax
8010517d:	78 19                	js     80105198 <sys_fstat+0x48>
  return filestat(f, st);
8010517f:	83 ec 08             	sub    $0x8,%esp
80105182:	ff 75 f4             	pushl  -0xc(%ebp)
80105185:	ff 75 f0             	pushl  -0x10(%ebp)
80105188:	e8 13 be ff ff       	call   80100fa0 <filestat>
...
801051a9:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
801051ac:	53                   	push   %ebx
801051ad:	83 ec 34             	sub    $0x34,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801051b0:	50                   	push   %eax
801051b1:	6a 00                	push   $0x0
801051b3:	e8 58 fb ff ff       	call   80104d10 <argstr>
801051b8:	83 c4 10             	add    $0x10,%esp
801051bb:	85 c0                	test   %eax,%eax
801051bd:	0f 88 ff 00 00 00    	js     801052c2 <sys_link+0x122>
801051c3:	83 ec 08             	sub    $0x8,%esp
801051c6:	8d 45 d0             	lea    -0x30(%ebp),%eax
801051c9:	50                   	push   %eax
801051ca:	6a 01                	push   $0x1
801051cc:	e8 3f fb ff ff       	call   80104d10 <argstr>
801051d1:	83 c4 10             	add    $0x10,%esp
801051d4:	85 c0                	test   %eax,%eax
801051d6:	0f 88 e6 00 00 00    	js     801052c2 <sys_link+0x122>
  begin_op();
801051dc:	e8 4f db ff ff       	call   80102d30 <begin_op>
  if((ip = namei(old)) == 0){
801051e1:	83 ec 0c             	sub    $0xc,%esp
801051e4:	ff 75 d4             	pushl  -0x2c(%ebp)
801051e7:	e8 44 ce ff ff       	call   80102030 <namei>
801051ec:	83 c4 10             	add    $0x10,%esp
801051ef:	89 c3                	mov    %eax,%ebx
801051f1:	85 c0                	test   %eax,%eax
801051f3:	0f 84 e8 00 00 00    	je     801052e1 <sys_link+0x141>
  ilock(ip);
...
80105205:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010520a:	0f 84 b9 00 00 00    	je     801052c9 <sys_link+0x129>
  iupdate(ip);
80105210:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
80105213:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80105218:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
8010521b:	53                   	push   %ebx
8010521c:	e8 7f c4 ff ff       	call   801016a0 <iupdate>
  iunlock(ip);
80105221:	89 1c 24             	mov    %ebx,(%esp)
80105224:	e8 17 c6 ff ff       	call   80101840 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105229:	58                   	pop    %eax
8010522a:	5a                   	pop    %edx
8010522b:	57                   	push   %edi
8010522c:	ff 75 d0             	pushl  -0x30(%ebp)
8010522f:	e8 1c ce ff ff       	call   80102050 <nameiparent>
80105234:	83 c4 10             	add    $0x10,%esp
80105237:	89 c6                	mov    %eax,%esi
80105239:	85 c0                	test   %eax,%eax
8010523b:	74 5f                	je     8010529c <sys_link+0xfc>
  ilock(dp);
8010523d:	83 ec 0c             	sub    $0xc,%esp
80105240:	50                   	push   %eax
80105241:	e8 1a c5 ff ff       	call   80101760 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105246:	8b 03                	mov    (%ebx),%eax
80105248:	83 c4 10             	add    $0x10,%esp
8010524b:	39 06                	cmp    %eax,(%esi)
8010524d:	75 41                	jne    80105290 <sys_link+0xf0>
8010524f:	83 ec 04             	sub    $0x4,%esp
80105252:	ff 73 04             	pushl  0x4(%ebx)
80105255:	57                   	push   %edi
80105256:	56                   	push   %esi
80105257:	e8 14 cd ff ff       	call   80101f70 <dirlink>
8010525c:	83 c4 10             	add    $0x10,%esp
8010525f:	85 c0                	test   %eax,%eax
80105261:	78 2d                	js     80105290 <sys_link+0xf0>
  iunlockput(dp);
80105263:	83 ec 0c             	sub    $0xc,%esp
80105266:	56                   	push   %esi
80105267:	e8 94 c7 ff ff       	call   80101a00 <iunlockput>
  iput(ip);
8010526c:	89 1c 24             	mov    %ebx,(%esp)
8010526f:	e8 1c c6 ff ff       	call   80101890 <iput>
  end_op();
80105274:	e8 27 db ff ff       	call   80102da0 <end_op>
  return 0;
...
80105294:	e8 67 c7 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
801052f8:	56                   	push   %esi
  if(argstr(0, &path) < 0)
801052f9:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
801052fc:	53                   	push   %ebx
801052fd:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
80105300:	50                   	push   %eax
80105301:	6a 00                	push   $0x0
80105303:	e8 08 fa ff ff       	call   80104d10 <argstr>
80105308:	83 c4 10             	add    $0x10,%esp
8010530b:	85 c0                	test   %eax,%eax
8010530d:	0f 88 7d 01 00 00    	js     80105490 <sys_unlink+0x1a0>
  begin_op();
80105313:	e8 18 da ff ff       	call   80102d30 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105318:	8d 5d ca             	lea    -0x36(%ebp),%ebx
8010531b:	83 ec 08             	sub    $0x8,%esp
8010531e:	53                   	push   %ebx
8010531f:	ff 75 c0             	pushl  -0x40(%ebp)
80105322:	e8 29 cd ff ff       	call   80102050 <nameiparent>
80105327:	83 c4 10             	add    $0x10,%esp
8010532a:	89 c6                	mov    %eax,%esi
8010532c:	85 c0                	test   %eax,%eax
8010532e:	0f 84 66 01 00 00    	je     8010549a <sys_unlink+0x1aa>
  ilock(dp);
80105334:	83 ec 0c             	sub    $0xc,%esp
80105337:	50                   	push   %eax
80105338:	e8 23 c4 ff ff       	call   80101760 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010533d:	58                   	pop    %eax
8010533e:	5a                   	pop    %edx
8010533f:	68 1c 7c 10 80       	push   $0x80107c1c
80105344:	53                   	push   %ebx
80105345:	e8 46 c9 ff ff       	call   80101c90 <namecmp>
8010534a:	83 c4 10             	add    $0x10,%esp
8010534d:	85 c0                	test   %eax,%eax
8010534f:	0f 84 03 01 00 00    	je     80105458 <sys_unlink+0x168>
80105355:	83 ec 08             	sub    $0x8,%esp
80105358:	68 1b 7c 10 80       	push   $0x80107c1b
8010535d:	53                   	push   %ebx
8010535e:	e8 2d c9 ff ff       	call   80101c90 <namecmp>
80105363:	83 c4 10             	add    $0x10,%esp
80105366:	85 c0                	test   %eax,%eax
80105368:	0f 84 ea 00 00 00    	je     80105458 <sys_unlink+0x168>
...
80105377:	e8 34 c9 ff ff       	call   80101cb0 <dirlookup>
8010537c:	83 c4 10             	add    $0x10,%esp
8010537f:	89 c3                	mov    %eax,%ebx
80105381:	85 c0                	test   %eax,%eax
80105383:	0f 84 cf 00 00 00    	je     80105458 <sys_unlink+0x168>
  ilock(ip);
80105389:	83 ec 0c             	sub    $0xc,%esp
8010538c:	50                   	push   %eax
8010538d:	e8 ce c3 ff ff       	call   80101760 <ilock>
  if(ip->nlink < 1)
80105392:	83 c4 10             	add    $0x10,%esp
80105395:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
8010539a:	0f 8e 23 01 00 00    	jle    801054c3 <sys_unlink+0x1d3>
  if(ip->type == T_DIR && !isdirempty(ip)){
801053a0:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801053a5:	8d 7d d8             	lea    -0x28(%ebp),%edi
801053a8:	74 66                	je     80105410 <sys_unlink+0x120>
  memset(&de, 0, sizeof(de));
801053aa:	83 ec 04             	sub    $0x4,%esp
801053ad:	6a 10                	push   $0x10
801053af:	6a 00                	push   $0x0
801053b1:	57                   	push   %edi
801053b2:	e8 c9 f5 ff ff       	call   80104980 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801053b7:	6a 10                	push   $0x10
801053b9:	ff 75 c4             	pushl  -0x3c(%ebp)
801053bc:	57                   	push   %edi
801053bd:	56                   	push   %esi
801053be:	e8 9d c7 ff ff       	call   80101b60 <writei>
801053c3:	83 c4 20             	add    $0x20,%esp
801053c6:	83 f8 10             	cmp    $0x10,%eax
801053c9:	0f 85 e7 00 00 00    	jne    801054b6 <sys_unlink+0x1c6>
  if(ip->type == T_DIR){
801053cf:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801053d4:	0f 84 96 00 00 00    	je     80105470 <sys_unlink+0x180>
  iunlockput(dp);
801053da:	83 ec 0c             	sub    $0xc,%esp
801053dd:	56                   	push   %esi
801053de:	e8 1d c6 ff ff       	call   80101a00 <iunlockput>
  ip->nlink--;
801053e3:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801053e8:	89 1c 24             	mov    %ebx,(%esp)
801053eb:	e8 b0 c2 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
...
80105402:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105405:	5b                   	pop    %ebx
80105406:	5e                   	pop    %esi
80105407:	5f                   	pop    %edi
80105408:	5d                   	pop    %ebp
...
80105414:	76 94                	jbe    801053aa <sys_unlink+0xba>
80105416:	ba 20 00 00 00       	mov    $0x20,%edx
8010541b:	eb 0b                	jmp    80105428 <sys_unlink+0x138>
8010541d:	8d 76 00             	lea    0x0(%esi),%esi
80105420:	83 c2 10             	add    $0x10,%edx
80105423:	39 53 58             	cmp    %edx,0x58(%ebx)
80105426:	76 82                	jbe    801053aa <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105428:	6a 10                	push   $0x10
8010542a:	52                   	push   %edx
8010542b:	57                   	push   %edi
8010542c:	53                   	push   %ebx
8010542d:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80105430:	e8 2b c6 ff ff       	call   80101a60 <readi>
80105435:	83 c4 10             	add    $0x10,%esp
80105438:	8b 55 b4             	mov    -0x4c(%ebp),%edx
8010543b:	83 f8 10             	cmp    $0x10,%eax
8010543e:	75 69                	jne    801054a9 <sys_unlink+0x1b9>
    if(de.inum != 0)
80105440:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105445:	74 d9                	je     80105420 <sys_unlink+0x130>
    iunlockput(ip);
80105447:	83 ec 0c             	sub    $0xc,%esp
8010544a:	53                   	push   %ebx
8010544b:	e8 b0 c5 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
80105495:	e9 68 ff ff ff       	jmp    80105402 <sys_unlink+0x112>
    end_op();
8010549a:	e8 01 d9 ff ff       	call   80102da0 <end_op>
    return -1;
8010549f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054a4:	e9 59 ff ff ff       	jmp    80105402 <sys_unlink+0x112>
      panic("isdirempty: readi");
801054a9:	83 ec 0c             	sub    $0xc,%esp
801054ac:	68 40 7c 10 80       	push   $0x80107c40
801054b1:	e8 da ae ff ff       	call   80100390 <panic>
    panic("unlink: writei");
801054b6:	83 ec 0c             	sub    $0xc,%esp
801054b9:	68 52 7c 10 80       	push   $0x80107c52
801054be:	e8 cd ae ff ff       	call   80100390 <panic>
    panic("unlink: nlink < 1");
801054c3:	83 ec 0c             	sub    $0xc,%esp
801054c6:	68 2e 7c 10 80       	push   $0x80107c2e
801054cb:	e8 c0 ae ff ff       	call   80100390 <panic>
...
801054dd:	83 ec 24             	sub    $0x24,%esp
  if(argstr(0, &path) < 0 || argint(1, &omode) < 0)
801054e0:	50                   	push   %eax
801054e1:	6a 00                	push   $0x0
801054e3:	e8 28 f8 ff ff       	call   80104d10 <argstr>
801054e8:	83 c4 10             	add    $0x10,%esp
801054eb:	85 c0                	test   %eax,%eax
801054ed:	0f 88 8a 00 00 00    	js     8010557d <sys_open+0xad>
801054f3:	83 ec 08             	sub    $0x8,%esp
801054f6:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801054f9:	50                   	push   %eax
801054fa:	6a 01                	push   $0x1
801054fc:	e8 5f f7 ff ff       	call   80104c60 <argint>
80105501:	83 c4 10             	add    $0x10,%esp
80105504:	85 c0                	test   %eax,%eax
80105506:	78 75                	js     8010557d <sys_open+0xad>
    return -1;

  begin_op();
80105508:	e8 23 d8 ff ff       	call   80102d30 <begin_op>

  if(omode & O_CREATE){
8010550d:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105511:	75 75                	jne    80105588 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105519:	e8 12 cb ff ff       	call   80102030 <namei>
8010551e:	83 c4 10             	add    $0x10,%esp
80105521:	89 c6                	mov    %eax,%esi
80105523:	85 c0                	test   %eax,%eax
80105525:	74 7e                	je     801055a5 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
8010552b:	e8 30 c2 ff ff       	call   80101760 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105530:	83 c4 10             	add    $0x10,%esp
80105533:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105538:	0f 84 c2 00 00 00    	je     80105600 <sys_open+0x130>
      end_op();
      return -1;
    }
  }
...
8010553e:	e8 bd b8 ff ff       	call   80100e00 <filealloc>
80105543:	89 c7                	mov    %eax,%edi
80105545:	85 c0                	test   %eax,%eax
80105547:	74 23                	je     8010556c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105549:	e8 32 e4 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010554e:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
80105550:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80105554:	85 d2                	test   %edx,%edx
80105556:	74 60                	je     801055b8 <sys_open+0xe8>
  for(fd = 0; fd < NOFILE; fd++){
...
80105564:	e8 57 b9 ff ff       	call   80100ec0 <fileclose>
80105569:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010556c:	83 ec 0c             	sub    $0xc,%esp
8010556f:	56                   	push   %esi
80105570:	e8 8b c4 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105575:	e8 26 d8 ff ff       	call   80102da0 <end_op>
    return -1;
8010557a:	83 c4 10             	add    $0x10,%esp
8010557d:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105582:	eb 6d                	jmp    801055f1 <sys_open+0x121>
80105584:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ip = create(path, T_FILE, 0, 0);
80105588:	83 ec 0c             	sub    $0xc,%esp
8010558b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010558e:	31 c9                	xor    %ecx,%ecx
80105590:	ba 02 00 00 00       	mov    $0x2,%edx
80105595:	6a 00                	push   $0x0
80105597:	e8 24 f8 ff ff       	call   80104dc0 <create>
    if(ip == 0){
8010559c:	83 c4 10             	add    $0x10,%esp
    ip = create(path, T_FILE, 0, 0);
8010559f:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801055a1:	85 c0                	test   %eax,%eax
801055a3:	75 99                	jne    8010553e <sys_open+0x6e>
      end_op();
801055a5:	e8 f6 d7 ff ff       	call   80102da0 <end_op>
      return -1;
801055aa:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801055af:	eb 40                	jmp    801055f1 <sys_open+0x121>
801055b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
801055b8:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801055bb:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
801055bf:	56                   	push   %esi
801055c0:	e8 7b c2 ff ff       	call   80101840 <iunlock>
  end_op();
801055c5:	e8 d6 d7 ff ff       	call   80102da0 <end_op>

  f->type = FD_INODE;
801055ca:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
801055d0:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801055d3:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
801055d6:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
801055d9:	89 d0                	mov    %edx,%eax
  f->off = 0;
801055db:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
801055e2:	f7 d0                	not    %eax
801055e4:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801055e7:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
801055ea:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801055ed:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
801055f1:	8d 65 f4             	lea    -0xc(%ebp),%esp
801055f4:	89 d8                	mov    %ebx,%eax
801055f6:	5b                   	pop    %ebx
801055f7:	5e                   	pop    %esi
801055f8:	5f                   	pop    %edi
801055f9:	5d                   	pop    %ebp
...
80105605:	0f 84 33 ff ff ff    	je     8010553e <sys_open+0x6e>
8010560b:	e9 5c ff ff ff       	jmp    8010556c <sys_open+0x9c>
...
80105628:	e8 e3 f6 ff ff       	call   80104d10 <argstr>
8010562d:	83 c4 10             	add    $0x10,%esp
80105630:	85 c0                	test   %eax,%eax
80105632:	78 34                	js     80105668 <sys_mkdir+0x58>
80105634:	83 ec 0c             	sub    $0xc,%esp
80105637:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010563a:	31 c9                	xor    %ecx,%ecx
8010563c:	ba 01 00 00 00       	mov    $0x1,%edx
80105641:	6a 00                	push   $0x0
80105643:	e8 78 f7 ff ff       	call   80104dc0 <create>
80105648:	83 c4 10             	add    $0x10,%esp
8010564b:	85 c0                	test   %eax,%eax
8010564d:	74 19                	je     80105668 <sys_mkdir+0x58>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80105687:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
8010568a:	e8 a1 d6 ff ff       	call   80102d30 <begin_op>
  if((argstr(0, &path)) < 0 ||
8010568f:	83 ec 08             	sub    $0x8,%esp
80105692:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105695:	50                   	push   %eax
80105696:	6a 00                	push   $0x0
80105698:	e8 73 f6 ff ff       	call   80104d10 <argstr>
8010569d:	83 c4 10             	add    $0x10,%esp
801056a0:	85 c0                	test   %eax,%eax
801056a2:	78 64                	js     80105708 <sys_mknod+0x88>
     argint(1, &major) < 0 ||
801056a4:	83 ec 08             	sub    $0x8,%esp
801056a7:	8d 45 f0             	lea    -0x10(%ebp),%eax
801056aa:	50                   	push   %eax
801056ab:	6a 01                	push   $0x1
801056ad:	e8 ae f5 ff ff       	call   80104c60 <argint>
  if((argstr(0, &path)) < 0 ||
801056b2:	83 c4 10             	add    $0x10,%esp
801056b5:	85 c0                	test   %eax,%eax
801056b7:	78 4f                	js     80105708 <sys_mknod+0x88>
     argint(2, &minor) < 0 ||
801056b9:	83 ec 08             	sub    $0x8,%esp
801056bc:	8d 45 f4             	lea    -0xc(%ebp),%eax
801056bf:	50                   	push   %eax
801056c0:	6a 02                	push   $0x2
801056c2:	e8 99 f5 ff ff       	call   80104c60 <argint>
     argint(1, &major) < 0 ||
801056c7:	83 c4 10             	add    $0x10,%esp
801056ca:	85 c0                	test   %eax,%eax
801056cc:	78 3a                	js     80105708 <sys_mknod+0x88>
     (ip = create(path, T_DEV, major, minor)) == 0){
801056ce:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
801056d2:	83 ec 0c             	sub    $0xc,%esp
801056d5:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
801056d9:	ba 03 00 00 00       	mov    $0x3,%edx
801056de:	50                   	push   %eax
801056df:	8b 45 ec             	mov    -0x14(%ebp),%eax
801056e2:	e8 d9 f6 ff ff       	call   80104dc0 <create>
     argint(2, &minor) < 0 ||
801056e7:	83 c4 10             	add    $0x10,%esp
801056ea:	85 c0                	test   %eax,%eax
801056ec:	74 1a                	je     80105708 <sys_mknod+0x88>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
801056f2:	e8 09 c3 ff ff       	call   80101a00 <iunlockput>
  end_op();
801056f7:	e8 a4 d6 ff ff       	call   80102da0 <end_op>
  return 0;
...
80105729:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010572c:	e8 4f e2 ff ff       	call   80103980 <myproc>
80105731:	89 c6                	mov    %eax,%esi
  
  begin_op();
80105733:	e8 f8 d5 ff ff       	call   80102d30 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105738:	83 ec 08             	sub    $0x8,%esp
8010573b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010573e:	50                   	push   %eax
8010573f:	6a 00                	push   $0x0
80105741:	e8 ca f5 ff ff       	call   80104d10 <argstr>
80105746:	83 c4 10             	add    $0x10,%esp
80105749:	85 c0                	test   %eax,%eax
8010574b:	78 73                	js     801057c0 <sys_chdir+0xa0>
8010574d:	83 ec 0c             	sub    $0xc,%esp
80105750:	ff 75 f4             	pushl  -0xc(%ebp)
80105753:	e8 d8 c8 ff ff       	call   80102030 <namei>
80105758:	83 c4 10             	add    $0x10,%esp
8010575b:	89 c3                	mov    %eax,%ebx
8010575d:	85 c0                	test   %eax,%eax
8010575f:	74 5f                	je     801057c0 <sys_chdir+0xa0>
    end_op();
    return -1;
  }
  ilock(ip);
...
80105765:	e8 f6 bf ff ff       	call   80101760 <ilock>
  if(ip->type != T_DIR){
8010576a:	83 c4 10             	add    $0x10,%esp
8010576d:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105772:	75 2c                	jne    801057a0 <sys_chdir+0x80>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80105778:	e8 c3 c0 ff ff       	call   80101840 <iunlock>
  iput(curproc->cwd);
8010577d:	58                   	pop    %eax
8010577e:	ff 76 6c             	pushl  0x6c(%esi)
80105781:	e8 0a c1 ff ff       	call   80101890 <iput>
  end_op();
80105786:	e8 15 d6 ff ff       	call   80102da0 <end_op>
  curproc->cwd = ip;
8010578b:	89 5e 6c             	mov    %ebx,0x6c(%esi)
  return 0;
8010578e:	83 c4 10             	add    $0x10,%esp
80105791:	31 c0                	xor    %eax,%eax
}
80105793:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105796:	5b                   	pop    %ebx
80105797:	5e                   	pop    %esi
80105798:	5d                   	pop    %ebp
80105799:	c3                   	ret    
...
801057a4:	e8 57 c2 ff ff       	call   80101a00 <iunlockput>
    end_op();
801057a9:	e8 f2 d5 ff ff       	call   80102da0 <end_op>
    return -1;
801057ae:	83 c4 10             	add    $0x10,%esp
801057b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057b6:	eb db                	jmp    80105793 <sys_chdir+0x73>
801057b8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801057bf:	90                   	nop
    end_op();
801057c0:	e8 db d5 ff ff       	call   80102da0 <end_op>
    return -1;
801057c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057ca:	eb c7                	jmp    80105793 <sys_chdir+0x73>
...
801057d9:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
801057df:	53                   	push   %ebx
801057e0:	81 ec a4 00 00 00    	sub    $0xa4,%esp
  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801057e6:	50                   	push   %eax
801057e7:	6a 00                	push   $0x0
801057e9:	e8 22 f5 ff ff       	call   80104d10 <argstr>
801057ee:	83 c4 10             	add    $0x10,%esp
801057f1:	85 c0                	test   %eax,%eax
801057f3:	0f 88 8b 00 00 00    	js     80105884 <sys_exec+0xb4>
801057f9:	83 ec 08             	sub    $0x8,%esp
801057fc:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105802:	50                   	push   %eax
80105803:	6a 01                	push   $0x1
80105805:	e8 56 f4 ff ff       	call   80104c60 <argint>
8010580a:	83 c4 10             	add    $0x10,%esp
8010580d:	85 c0                	test   %eax,%eax
8010580f:	78 73                	js     80105884 <sys_exec+0xb4>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105811:	83 ec 04             	sub    $0x4,%esp
80105814:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
8010581a:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
8010581c:	68 80 00 00 00       	push   $0x80
80105821:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105827:	6a 00                	push   $0x0
80105829:	50                   	push   %eax
8010582a:	e8 51 f1 ff ff       	call   80104980 <memset>
8010582f:	83 c4 10             	add    $0x10,%esp
80105832:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105838:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
8010583e:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
80105845:	83 ec 08             	sub    $0x8,%esp
80105848:	57                   	push   %edi
80105849:	01 f0                	add    %esi,%eax
8010584b:	50                   	push   %eax
8010584c:	e8 6f f3 ff ff       	call   80104bc0 <fetchint>
80105851:	83 c4 10             	add    $0x10,%esp
80105854:	85 c0                	test   %eax,%eax
80105856:	78 2c                	js     80105884 <sys_exec+0xb4>
      return -1;
    if(uarg == 0){
80105858:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010585e:	85 c0                	test   %eax,%eax
80105860:	74 36                	je     80105898 <sys_exec+0xc8>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105862:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
80105868:	83 ec 08             	sub    $0x8,%esp
8010586b:	8d 14 31             	lea    (%ecx,%esi,1),%edx
8010586e:	52                   	push   %edx
8010586f:	50                   	push   %eax
80105870:	e8 8b f3 ff ff       	call   80104c00 <fetchstr>
80105875:	83 c4 10             	add    $0x10,%esp
80105878:	85 c0                	test   %eax,%eax
8010587a:	78 08                	js     80105884 <sys_exec+0xb4>
  for(i=0;; i++){
8010587c:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
8010587f:	83 fb 20             	cmp    $0x20,%ebx
80105882:	75 b4                	jne    80105838 <sys_exec+0x68>
      return -1;
  }
...
8010589b:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
      argv[i] = 0;
801058a1:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
801058a8:	00 00 00 00 
  return exec(path, argv);
801058ac:	50                   	push   %eax
801058ad:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
801058b3:	e8 c8 b1 ff ff       	call   80100a80 <exec>
...
801058d9:	8d 45 dc             	lea    -0x24(%ebp),%eax
{
801058dc:	53                   	push   %ebx
801058dd:	83 ec 20             	sub    $0x20,%esp
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801058e0:	6a 08                	push   $0x8
801058e2:	50                   	push   %eax
801058e3:	6a 00                	push   $0x0
801058e5:	e8 c6 f3 ff ff       	call   80104cb0 <argptr>
801058ea:	83 c4 10             	add    $0x10,%esp
801058ed:	85 c0                	test   %eax,%eax
801058ef:	78 4e                	js     8010593f <sys_pipe+0x6f>
    return -1;
...
801058fc:	e8 ef da ff ff       	call   801033f0 <pipealloc>
80105901:	83 c4 10             	add    $0x10,%esp
80105904:	85 c0                	test   %eax,%eax
80105906:	78 37                	js     8010593f <sys_pipe+0x6f>
    return -1;
  fd0 = -1;
...
801059b0:	f3 0f 1e fb          	endbr32 
  return fork();
801059b4:	e9 b7 e1 ff ff       	jmp    80103b70 <fork>
...
801059c7:	83 ec 08             	sub    $0x8,%esp
  exit();
801059ca:	e8 71 e5 ff ff       	call   80103f40 <exit>
  return 0;  // not reached
}
801059cf:	31 c0                	xor    %eax,%eax
801059d1:	c9                   	leave  
801059d2:	c3                   	ret    
801059d3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80105a00:	e8 5b f2 ff ff       	call   80104c60 <argint>
80105a05:	83 c4 10             	add    $0x10,%esp
80105a08:	85 c0                	test   %eax,%eax
80105a0a:	78 14                	js     80105a20 <sys_kill+0x30>
    return -1;
  return kill(pid);
80105a0c:	83 ec 0c             	sub    $0xc,%esp
80105a0f:	ff 75 f4             	pushl  -0xc(%ebp)
80105a12:	e8 29 ea ff ff       	call   80104440 <kill>
...
80105a3f:	8b 40 14             	mov    0x14(%eax),%eax
}
80105a42:	c9                   	leave  
80105a43:	c3                   	ret    
...
80105a61:	e8 fa f1 ff ff       	call   80104c60 <argint>
80105a66:	83 c4 10             	add    $0x10,%esp
80105a69:	85 c0                	test   %eax,%eax
80105a6b:	78 23                	js     80105a90 <sys_sbrk+0x40>
    return -1;
  //acquire(&memlock);
  addr = myproc()->sz;
80105a6d:	e8 0e df ff ff       	call   80103980 <myproc>
  if(growproc(n) < 0){
80105a72:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105a75:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0){
80105a77:	ff 75 f4             	pushl  -0xc(%ebp)
80105a7a:	e8 31 e0 ff ff       	call   80103ab0 <growproc>
80105a7f:	83 c4 10             	add    $0x10,%esp
80105a82:	85 c0                	test   %eax,%eax
80105a84:	78 0a                	js     80105a90 <sys_sbrk+0x40>
    //release(&memlock);
    return -1;
  }
  //release(&memlock);
...
80105a86:	89 d8                	mov    %ebx,%eax
80105a88:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105a8b:	c9                   	leave  
80105a8c:	c3                   	ret    
80105a8d:	8d 76 00             	lea    0x0(%esi),%esi
    return -1;
80105a90:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105a95:	eb ef                	jmp    80105a86 <sys_sbrk+0x36>
...
80105ab1:	e8 aa f1 ff ff       	call   80104c60 <argint>
80105ab6:	83 c4 10             	add    $0x10,%esp
80105ab9:	85 c0                	test   %eax,%eax
80105abb:	0f 88 86 00 00 00    	js     80105b47 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
80105ac1:	83 ec 0c             	sub    $0xc,%esp
80105ac4:	68 a0 4e 11 80       	push   $0x80114ea0
80105ac9:	e8 a2 ed ff ff       	call   80104870 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105ace:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105ad1:	8b 1d e0 56 11 80    	mov    0x801156e0,%ebx
  while(ticks - ticks0 < n){
80105ad7:	83 c4 10             	add    $0x10,%esp
80105ada:	85 d2                	test   %edx,%edx
80105adc:	75 23                	jne    80105b01 <sys_sleep+0x61>
80105ade:	eb 50                	jmp    80105b30 <sys_sleep+0x90>
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
...
80105ae3:	68 a0 4e 11 80       	push   $0x80114ea0
80105ae8:	68 e0 56 11 80       	push   $0x801156e0
80105aed:	e8 de e5 ff ff       	call   801040d0 <sleep>
  while(ticks - ticks0 < n){
80105af2:	a1 e0 56 11 80       	mov    0x801156e0,%eax
...
80105b06:	8b 40 28             	mov    0x28(%eax),%eax
80105b09:	85 c0                	test   %eax,%eax
80105b0b:	74 d3                	je     80105ae0 <sys_sleep+0x40>
      release(&tickslock);
80105b0d:	83 ec 0c             	sub    $0xc,%esp
80105b10:	68 a0 4e 11 80       	push   $0x80114ea0
80105b15:	e8 16 ee ff ff       	call   80104930 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105b33:	68 a0 4e 11 80       	push   $0x80114ea0
80105b38:	e8 f3 ed ff ff       	call   80104930 <release>
  return 0;
...
80105b58:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b5b:	68 a0 4e 11 80       	push   $0x80114ea0
80105b60:	e8 0b ed ff ff       	call   80104870 <acquire>
  xticks = ticks;
80105b65:	8b 1d e0 56 11 80    	mov    0x801156e0,%ebx
  release(&tickslock);
80105b6b:	c7 04 24 a0 4e 11 80 	movl   $0x80114ea0,(%esp)
80105b72:	e8 b9 ed ff ff       	call   80104930 <release>
  return xticks;
}
80105b77:	89 d8                	mov    %ebx,%eax
80105b79:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105b7c:	c9                   	leave  
80105b7d:	c3                   	ret    
...
80105bc0:	e8 eb f0 ff ff       	call   80104cb0 <argptr>
80105bc5:	83 c4 10             	add    $0x10,%esp
80105bc8:	85 c0                	test   %eax,%eax
80105bca:	78 34                	js     80105c00 <sys_clone+0x80>
80105bcc:	83 ec 04             	sub    $0x4,%esp
80105bcf:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105bd2:	6a 04                	push   $0x4
80105bd4:	50                   	push   %eax
80105bd5:	6a 03                	push   $0x3
80105bd7:	e8 d4 f0 ff ff       	call   80104cb0 <argptr>
80105bdc:	83 c4 10             	add    $0x10,%esp
80105bdf:	85 c0                	test   %eax,%eax
80105be1:	78 1d                	js     80105c00 <sys_clone+0x80>
    return -1;
  return clone((void *)fcn, (void *)arg1, (void *)arg2, (void *)stack);
80105be3:	ff 75 f4             	pushl  -0xc(%ebp)
80105be6:	ff 75 f0             	pushl  -0x10(%ebp)
80105be9:	ff 75 ec             	pushl  -0x14(%ebp)
80105bec:	ff 75 e8             	pushl  -0x18(%ebp)
80105bef:	e8 9c e0 ff ff       	call   80103c90 <clone>
...
80105c1a:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105c1d:	6a 04                	push   $0x4
80105c1f:	50                   	push   %eax
80105c20:	6a 00                	push   $0x0
80105c22:	e8 89 f0 ff ff       	call   80104cb0 <argptr>
80105c27:	83 c4 10             	add    $0x10,%esp
80105c2a:	85 c0                	test   %eax,%eax
80105c2c:	78 12                	js     80105c40 <sys_join+0x30>
    return -1;
  return join(stack);
80105c2e:	83 ec 0c             	sub    $0xc,%esp
80105c31:	ff 75 f4             	pushl  -0xc(%ebp)
80105c34:	e8 57 e5 ff ff       	call   80104190 <join>
...
80105c48:	06                   	push   %es
  pushl %fs
80105c49:	0f a0                	push   %fs
  pushl %gs
80105c4b:	0f a8                	push   %gs
  pushal
80105c4d:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105c4e:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105c52:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105c54:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105c56:	54                   	push   %esp
  call trap
80105c57:	e8 c4 00 00 00       	call   80105d20 <trap>
  addl $4, %esp
80105c5c:	83 c4 04             	add    $0x4,%esp
...
80105c5f:	61                   	popa   
  popl %gs
80105c60:	0f a9                	pop    %gs
  popl %fs
80105c62:	0f a1                	pop    %fs
  popl %es
80105c64:	07                   	pop    %es
  popl %ds
80105c65:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105c66:	83 c4 08             	add    $0x8,%esp
  iret
80105c69:	cf                   	iret   
...
80105c87:	c7 04 c5 e2 4e 11 80 	movl   $0x8e000008,-0x7feeb11e(,%eax,8)
80105c8e:	08 00 00 8e 
80105c92:	66 89 14 c5 e0 4e 11 	mov    %dx,-0x7feeb120(,%eax,8)
80105c99:	80 
80105c9a:	c1 ea 10             	shr    $0x10,%edx
80105c9d:	66 89 14 c5 e6 4e 11 	mov    %dx,-0x7feeb11a(,%eax,8)
80105ca4:	80 
  for(i = 0; i < 256; i++)
...
80105cb7:	c7 05 e2 50 11 80 08 	movl   $0xef000008,0x801150e2
80105cbe:	00 00 ef 
  initlock(&tickslock, "time");
80105cc1:	68 61 7c 10 80       	push   $0x80107c61
80105cc6:	68 a0 4e 11 80       	push   $0x80114ea0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ccb:	66 a3 e0 50 11 80    	mov    %ax,0x801150e0
80105cd1:	c1 e8 10             	shr    $0x10,%eax
80105cd4:	66 a3 e6 50 11 80    	mov    %ax,0x801150e6
  initlock(&tickslock, "time");
80105cda:	e8 11 ea ff ff       	call   801046f0 <initlock>
}
...
80105cff:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105d03:	b8 e0 4e 11 80       	mov    $0x80114ee0,%eax
...
80105d44:	3e ff 24 85 08 7d 10 	notrack jmp *-0x7fef82f8(,%eax,4)
80105d4b:	80 
    lapiceoi();
    break;
...
80105d4c:	e8 2f dc ff ff       	call   80103980 <myproc>
...
80105d7d:	e8 fe db ff ff       	call   80103980 <myproc>
80105d82:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105d85:	e8 f6 db ff ff       	call   80103980 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105d9a:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105d9d:	56                   	push   %esi
80105d9e:	ff 70 14             	pushl  0x14(%eax)
80105da1:	68 c4 7c 10 80       	push   $0x80107cc4
80105da6:	e8 05 a9 ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105dab:	83 c4 20             	add    $0x20,%esp
80105dae:	e8 cd db ff ff       	call   80103980 <myproc>
80105db3:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  }
...
80105dc8:	8b 50 28             	mov    0x28(%eax),%edx
...
80105dee:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
...
80105e06:	8b 40 28             	mov    0x28(%eax),%eax
...
80105e39:	eb a5                	jmp    80105de0 <trap+0xc0>
    if(cpuid() == 0){
80105e3b:	e8 20 db ff ff       	call   80103960 <cpuid>
80105e40:	85 c0                	test   %eax,%eax
80105e42:	75 e7                	jne    80105e2b <trap+0x10b>
      acquire(&tickslock);
80105e44:	83 ec 0c             	sub    $0xc,%esp
80105e47:	68 a0 4e 11 80       	push   $0x80114ea0
80105e4c:	e8 1f ea ff ff       	call   80104870 <acquire>
      wakeup(&ticks);
80105e51:	c7 04 24 e0 56 11 80 	movl   $0x801156e0,(%esp)
      ticks++;
80105e58:	83 05 e0 56 11 80 01 	addl   $0x1,0x801156e0
      wakeup(&ticks);
80105e5f:	e8 6c e5 ff ff       	call   801043d0 <wakeup>
      release(&tickslock);
80105e64:	c7 04 24 a0 4e 11 80 	movl   $0x80114ea0,(%esp)
80105e6b:	e8 c0 ea ff ff       	call   80104930 <release>
...
80105e7a:	e8 41 ca ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e7f:	e8 fc da ff ff       	call   80103980 <myproc>
...
80105e96:	e8 25 ca ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e9b:	e8 e0 da ff ff       	call   80103980 <myproc>
...
80105eb4:	e8 a7 da ff ff       	call   80103960 <cpuid>
80105eb9:	57                   	push   %edi
80105eba:	56                   	push   %esi
80105ebb:	50                   	push   %eax
80105ebc:	68 6c 7c 10 80       	push   $0x80107c6c
...
80105ecb:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ece:	e8 ad da ff ff       	call   80103980 <myproc>
...
80105ee4:	0f 85 0e ff ff ff    	jne    80105df8 <trap+0xd8>
    yield();
80105eea:	e8 91 e1 ff ff       	call   80104080 <yield>
80105eef:	e9 04 ff ff ff       	jmp    80105df8 <trap+0xd8>
80105ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105ef8:	e8 83 da ff ff       	call   80103980 <myproc>
80105efd:	8b 70 28             	mov    0x28(%eax),%esi
80105f00:	85 f6                	test   %esi,%esi
80105f02:	75 3c                	jne    80105f40 <trap+0x220>
    myproc()->tf = tf;
80105f04:	e8 77 da ff ff       	call   80103980 <myproc>
80105f09:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105f0c:	e8 3f ee ff ff       	call   80104d50 <syscall>
    if(myproc()->killed)
80105f11:	e8 6a da ff ff       	call   80103980 <myproc>
80105f16:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105f58:	68 90 7c 10 80       	push   $0x80107c90
80105f5d:	e8 4e a7 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105f62:	83 c4 14             	add    $0x14,%esp
80105f65:	68 66 7c 10 80       	push   $0x80107c66
...
80106063:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106068:	bb 88 7d 10 80       	mov    $0x80107d88,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801060fb:	6a 00                	push   $0x0
  jmp alltraps
801060fd:	e9 45 fb ff ff       	jmp    80105c47 <alltraps>
...
80106104:	6a 01                	push   $0x1
  jmp alltraps
80106106:	e9 3c fb ff ff       	jmp    80105c47 <alltraps>
...
8010610d:	6a 02                	push   $0x2
  jmp alltraps
8010610f:	e9 33 fb ff ff       	jmp    80105c47 <alltraps>
...
80106116:	6a 03                	push   $0x3
  jmp alltraps
80106118:	e9 2a fb ff ff       	jmp    80105c47 <alltraps>
...
8010611f:	6a 04                	push   $0x4
  jmp alltraps
80106121:	e9 21 fb ff ff       	jmp    80105c47 <alltraps>
...
80106128:	6a 05                	push   $0x5
  jmp alltraps
8010612a:	e9 18 fb ff ff       	jmp    80105c47 <alltraps>
...
80106131:	6a 06                	push   $0x6
  jmp alltraps
80106133:	e9 0f fb ff ff       	jmp    80105c47 <alltraps>
...
8010613a:	6a 07                	push   $0x7
  jmp alltraps
8010613c:	e9 06 fb ff ff       	jmp    80105c47 <alltraps>
...
80106141:	6a 08                	push   $0x8
  jmp alltraps
80106143:	e9 ff fa ff ff       	jmp    80105c47 <alltraps>
...
8010614a:	6a 09                	push   $0x9
  jmp alltraps
8010614c:	e9 f6 fa ff ff       	jmp    80105c47 <alltraps>
...
80106151:	6a 0a                	push   $0xa
  jmp alltraps
80106153:	e9 ef fa ff ff       	jmp    80105c47 <alltraps>
...
80106158:	6a 0b                	push   $0xb
  jmp alltraps
8010615a:	e9 e8 fa ff ff       	jmp    80105c47 <alltraps>
...
8010615f:	6a 0c                	push   $0xc
  jmp alltraps
80106161:	e9 e1 fa ff ff       	jmp    80105c47 <alltraps>
...
80106166:	6a 0d                	push   $0xd
  jmp alltraps
80106168:	e9 da fa ff ff       	jmp    80105c47 <alltraps>
...
8010616d:	6a 0e                	push   $0xe
  jmp alltraps
8010616f:	e9 d3 fa ff ff       	jmp    80105c47 <alltraps>
...
80106176:	6a 0f                	push   $0xf
  jmp alltraps
80106178:	e9 ca fa ff ff       	jmp    80105c47 <alltraps>
...
8010617f:	6a 10                	push   $0x10
  jmp alltraps
80106181:	e9 c1 fa ff ff       	jmp    80105c47 <alltraps>
...
80106186:	6a 11                	push   $0x11
  jmp alltraps
80106188:	e9 ba fa ff ff       	jmp    80105c47 <alltraps>
...
8010618f:	6a 12                	push   $0x12
  jmp alltraps
80106191:	e9 b1 fa ff ff       	jmp    80105c47 <alltraps>
...
80106198:	6a 13                	push   $0x13
  jmp alltraps
8010619a:	e9 a8 fa ff ff       	jmp    80105c47 <alltraps>
...
801061a1:	6a 14                	push   $0x14
  jmp alltraps
801061a3:	e9 9f fa ff ff       	jmp    80105c47 <alltraps>
...
801061aa:	6a 15                	push   $0x15
  jmp alltraps
801061ac:	e9 96 fa ff ff       	jmp    80105c47 <alltraps>
...
801061b3:	6a 16                	push   $0x16
  jmp alltraps
801061b5:	e9 8d fa ff ff       	jmp    80105c47 <alltraps>
...
801061bc:	6a 17                	push   $0x17
  jmp alltraps
801061be:	e9 84 fa ff ff       	jmp    80105c47 <alltraps>
...
801061c5:	6a 18                	push   $0x18
  jmp alltraps
801061c7:	e9 7b fa ff ff       	jmp    80105c47 <alltraps>
...
801061ce:	6a 19                	push   $0x19
  jmp alltraps
801061d0:	e9 72 fa ff ff       	jmp    80105c47 <alltraps>
...
801061d7:	6a 1a                	push   $0x1a
  jmp alltraps
801061d9:	e9 69 fa ff ff       	jmp    80105c47 <alltraps>
...
801061e0:	6a 1b                	push   $0x1b
  jmp alltraps
801061e2:	e9 60 fa ff ff       	jmp    80105c47 <alltraps>
...
801061e9:	6a 1c                	push   $0x1c
  jmp alltraps
801061eb:	e9 57 fa ff ff       	jmp    80105c47 <alltraps>
...
801061f2:	6a 1d                	push   $0x1d
  jmp alltraps
801061f4:	e9 4e fa ff ff       	jmp    80105c47 <alltraps>
...
801061fb:	6a 1e                	push   $0x1e
  jmp alltraps
801061fd:	e9 45 fa ff ff       	jmp    80105c47 <alltraps>
...
80106204:	6a 1f                	push   $0x1f
  jmp alltraps
80106206:	e9 3c fa ff ff       	jmp    80105c47 <alltraps>
...
8010620d:	6a 20                	push   $0x20
  jmp alltraps
8010620f:	e9 33 fa ff ff       	jmp    80105c47 <alltraps>
...
80106216:	6a 21                	push   $0x21
  jmp alltraps
80106218:	e9 2a fa ff ff       	jmp    80105c47 <alltraps>
...
8010621f:	6a 22                	push   $0x22
  jmp alltraps
80106221:	e9 21 fa ff ff       	jmp    80105c47 <alltraps>
...
80106228:	6a 23                	push   $0x23
  jmp alltraps
8010622a:	e9 18 fa ff ff       	jmp    80105c47 <alltraps>
...
80106231:	6a 24                	push   $0x24
  jmp alltraps
80106233:	e9 0f fa ff ff       	jmp    80105c47 <alltraps>
...
8010623a:	6a 25                	push   $0x25
  jmp alltraps
8010623c:	e9 06 fa ff ff       	jmp    80105c47 <alltraps>
...
80106243:	6a 26                	push   $0x26
  jmp alltraps
80106245:	e9 fd f9 ff ff       	jmp    80105c47 <alltraps>
...
8010624c:	6a 27                	push   $0x27
  jmp alltraps
8010624e:	e9 f4 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106255:	6a 28                	push   $0x28
  jmp alltraps
80106257:	e9 eb f9 ff ff       	jmp    80105c47 <alltraps>
...
8010625e:	6a 29                	push   $0x29
  jmp alltraps
80106260:	e9 e2 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106267:	6a 2a                	push   $0x2a
  jmp alltraps
80106269:	e9 d9 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106270:	6a 2b                	push   $0x2b
  jmp alltraps
80106272:	e9 d0 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106279:	6a 2c                	push   $0x2c
  jmp alltraps
8010627b:	e9 c7 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106282:	6a 2d                	push   $0x2d
  jmp alltraps
80106284:	e9 be f9 ff ff       	jmp    80105c47 <alltraps>
...
8010628b:	6a 2e                	push   $0x2e
  jmp alltraps
8010628d:	e9 b5 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106294:	6a 2f                	push   $0x2f
  jmp alltraps
80106296:	e9 ac f9 ff ff       	jmp    80105c47 <alltraps>
...
8010629d:	6a 30                	push   $0x30
  jmp alltraps
8010629f:	e9 a3 f9 ff ff       	jmp    80105c47 <alltraps>
...
801062a6:	6a 31                	push   $0x31
  jmp alltraps
801062a8:	e9 9a f9 ff ff       	jmp    80105c47 <alltraps>
...
801062af:	6a 32                	push   $0x32
  jmp alltraps
801062b1:	e9 91 f9 ff ff       	jmp    80105c47 <alltraps>
...
801062b8:	6a 33                	push   $0x33
  jmp alltraps
801062ba:	e9 88 f9 ff ff       	jmp    80105c47 <alltraps>
...
801062c1:	6a 34                	push   $0x34
  jmp alltraps
801062c3:	e9 7f f9 ff ff       	jmp    80105c47 <alltraps>
...
801062ca:	6a 35                	push   $0x35
  jmp alltraps
801062cc:	e9 76 f9 ff ff       	jmp    80105c47 <alltraps>
...
801062d3:	6a 36                	push   $0x36
  jmp alltraps
801062d5:	e9 6d f9 ff ff       	jmp    80105c47 <alltraps>
...
801062dc:	6a 37                	push   $0x37
  jmp alltraps
801062de:	e9 64 f9 ff ff       	jmp    80105c47 <alltraps>
...
801062e5:	6a 38                	push   $0x38
  jmp alltraps
801062e7:	e9 5b f9 ff ff       	jmp    80105c47 <alltraps>
...
801062ee:	6a 39                	push   $0x39
  jmp alltraps
801062f0:	e9 52 f9 ff ff       	jmp    80105c47 <alltraps>
...
801062f7:	6a 3a                	push   $0x3a
  jmp alltraps
801062f9:	e9 49 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106300:	6a 3b                	push   $0x3b
  jmp alltraps
80106302:	e9 40 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106309:	6a 3c                	push   $0x3c
  jmp alltraps
8010630b:	e9 37 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106312:	6a 3d                	push   $0x3d
  jmp alltraps
80106314:	e9 2e f9 ff ff       	jmp    80105c47 <alltraps>
...
8010631b:	6a 3e                	push   $0x3e
  jmp alltraps
8010631d:	e9 25 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106324:	6a 3f                	push   $0x3f
  jmp alltraps
80106326:	e9 1c f9 ff ff       	jmp    80105c47 <alltraps>
...
8010632d:	6a 40                	push   $0x40
  jmp alltraps
8010632f:	e9 13 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106336:	6a 41                	push   $0x41
  jmp alltraps
80106338:	e9 0a f9 ff ff       	jmp    80105c47 <alltraps>
...
8010633f:	6a 42                	push   $0x42
  jmp alltraps
80106341:	e9 01 f9 ff ff       	jmp    80105c47 <alltraps>
...
80106348:	6a 43                	push   $0x43
  jmp alltraps
8010634a:	e9 f8 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106351:	6a 44                	push   $0x44
  jmp alltraps
80106353:	e9 ef f8 ff ff       	jmp    80105c47 <alltraps>
...
8010635a:	6a 45                	push   $0x45
  jmp alltraps
8010635c:	e9 e6 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106363:	6a 46                	push   $0x46
  jmp alltraps
80106365:	e9 dd f8 ff ff       	jmp    80105c47 <alltraps>
...
8010636c:	6a 47                	push   $0x47
  jmp alltraps
8010636e:	e9 d4 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106375:	6a 48                	push   $0x48
  jmp alltraps
80106377:	e9 cb f8 ff ff       	jmp    80105c47 <alltraps>
...
8010637e:	6a 49                	push   $0x49
  jmp alltraps
80106380:	e9 c2 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106387:	6a 4a                	push   $0x4a
  jmp alltraps
80106389:	e9 b9 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106390:	6a 4b                	push   $0x4b
  jmp alltraps
80106392:	e9 b0 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106399:	6a 4c                	push   $0x4c
  jmp alltraps
8010639b:	e9 a7 f8 ff ff       	jmp    80105c47 <alltraps>
...
801063a2:	6a 4d                	push   $0x4d
  jmp alltraps
801063a4:	e9 9e f8 ff ff       	jmp    80105c47 <alltraps>
...
801063ab:	6a 4e                	push   $0x4e
  jmp alltraps
801063ad:	e9 95 f8 ff ff       	jmp    80105c47 <alltraps>
...
801063b4:	6a 4f                	push   $0x4f
  jmp alltraps
801063b6:	e9 8c f8 ff ff       	jmp    80105c47 <alltraps>
...
801063bd:	6a 50                	push   $0x50
  jmp alltraps
801063bf:	e9 83 f8 ff ff       	jmp    80105c47 <alltraps>
...
801063c6:	6a 51                	push   $0x51
  jmp alltraps
801063c8:	e9 7a f8 ff ff       	jmp    80105c47 <alltraps>
...
801063cf:	6a 52                	push   $0x52
  jmp alltraps
801063d1:	e9 71 f8 ff ff       	jmp    80105c47 <alltraps>
...
801063d8:	6a 53                	push   $0x53
  jmp alltraps
801063da:	e9 68 f8 ff ff       	jmp    80105c47 <alltraps>
...
801063e1:	6a 54                	push   $0x54
  jmp alltraps
801063e3:	e9 5f f8 ff ff       	jmp    80105c47 <alltraps>
...
801063ea:	6a 55                	push   $0x55
  jmp alltraps
801063ec:	e9 56 f8 ff ff       	jmp    80105c47 <alltraps>
...
801063f3:	6a 56                	push   $0x56
  jmp alltraps
801063f5:	e9 4d f8 ff ff       	jmp    80105c47 <alltraps>
...
801063fc:	6a 57                	push   $0x57
  jmp alltraps
801063fe:	e9 44 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106405:	6a 58                	push   $0x58
  jmp alltraps
80106407:	e9 3b f8 ff ff       	jmp    80105c47 <alltraps>
...
8010640e:	6a 59                	push   $0x59
  jmp alltraps
80106410:	e9 32 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106417:	6a 5a                	push   $0x5a
  jmp alltraps
80106419:	e9 29 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106420:	6a 5b                	push   $0x5b
  jmp alltraps
80106422:	e9 20 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106429:	6a 5c                	push   $0x5c
  jmp alltraps
8010642b:	e9 17 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106432:	6a 5d                	push   $0x5d
  jmp alltraps
80106434:	e9 0e f8 ff ff       	jmp    80105c47 <alltraps>
...
8010643b:	6a 5e                	push   $0x5e
  jmp alltraps
8010643d:	e9 05 f8 ff ff       	jmp    80105c47 <alltraps>
...
80106444:	6a 5f                	push   $0x5f
  jmp alltraps
80106446:	e9 fc f7 ff ff       	jmp    80105c47 <alltraps>
...
8010644d:	6a 60                	push   $0x60
  jmp alltraps
8010644f:	e9 f3 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106456:	6a 61                	push   $0x61
  jmp alltraps
80106458:	e9 ea f7 ff ff       	jmp    80105c47 <alltraps>
...
8010645f:	6a 62                	push   $0x62
  jmp alltraps
80106461:	e9 e1 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106468:	6a 63                	push   $0x63
  jmp alltraps
8010646a:	e9 d8 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106471:	6a 64                	push   $0x64
  jmp alltraps
80106473:	e9 cf f7 ff ff       	jmp    80105c47 <alltraps>
...
8010647a:	6a 65                	push   $0x65
  jmp alltraps
8010647c:	e9 c6 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106483:	6a 66                	push   $0x66
  jmp alltraps
80106485:	e9 bd f7 ff ff       	jmp    80105c47 <alltraps>
...
8010648c:	6a 67                	push   $0x67
  jmp alltraps
8010648e:	e9 b4 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106495:	6a 68                	push   $0x68
  jmp alltraps
80106497:	e9 ab f7 ff ff       	jmp    80105c47 <alltraps>
...
8010649e:	6a 69                	push   $0x69
  jmp alltraps
801064a0:	e9 a2 f7 ff ff       	jmp    80105c47 <alltraps>
...
801064a7:	6a 6a                	push   $0x6a
  jmp alltraps
801064a9:	e9 99 f7 ff ff       	jmp    80105c47 <alltraps>
...
801064b0:	6a 6b                	push   $0x6b
  jmp alltraps
801064b2:	e9 90 f7 ff ff       	jmp    80105c47 <alltraps>
...
801064b9:	6a 6c                	push   $0x6c
  jmp alltraps
801064bb:	e9 87 f7 ff ff       	jmp    80105c47 <alltraps>
...
801064c2:	6a 6d                	push   $0x6d
  jmp alltraps
801064c4:	e9 7e f7 ff ff       	jmp    80105c47 <alltraps>
...
801064cb:	6a 6e                	push   $0x6e
  jmp alltraps
801064cd:	e9 75 f7 ff ff       	jmp    80105c47 <alltraps>
...
801064d4:	6a 6f                	push   $0x6f
  jmp alltraps
801064d6:	e9 6c f7 ff ff       	jmp    80105c47 <alltraps>
...
801064dd:	6a 70                	push   $0x70
  jmp alltraps
801064df:	e9 63 f7 ff ff       	jmp    80105c47 <alltraps>
...
801064e6:	6a 71                	push   $0x71
  jmp alltraps
801064e8:	e9 5a f7 ff ff       	jmp    80105c47 <alltraps>
...
801064ef:	6a 72                	push   $0x72
  jmp alltraps
801064f1:	e9 51 f7 ff ff       	jmp    80105c47 <alltraps>
...
801064f8:	6a 73                	push   $0x73
  jmp alltraps
801064fa:	e9 48 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106501:	6a 74                	push   $0x74
  jmp alltraps
80106503:	e9 3f f7 ff ff       	jmp    80105c47 <alltraps>
...
8010650a:	6a 75                	push   $0x75
  jmp alltraps
8010650c:	e9 36 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106513:	6a 76                	push   $0x76
  jmp alltraps
80106515:	e9 2d f7 ff ff       	jmp    80105c47 <alltraps>
...
8010651c:	6a 77                	push   $0x77
  jmp alltraps
8010651e:	e9 24 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106525:	6a 78                	push   $0x78
  jmp alltraps
80106527:	e9 1b f7 ff ff       	jmp    80105c47 <alltraps>
...
8010652e:	6a 79                	push   $0x79
  jmp alltraps
80106530:	e9 12 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106537:	6a 7a                	push   $0x7a
  jmp alltraps
80106539:	e9 09 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106540:	6a 7b                	push   $0x7b
  jmp alltraps
80106542:	e9 00 f7 ff ff       	jmp    80105c47 <alltraps>
...
80106549:	6a 7c                	push   $0x7c
  jmp alltraps
8010654b:	e9 f7 f6 ff ff       	jmp    80105c47 <alltraps>
...
80106552:	6a 7d                	push   $0x7d
  jmp alltraps
80106554:	e9 ee f6 ff ff       	jmp    80105c47 <alltraps>
...
8010655b:	6a 7e                	push   $0x7e
  jmp alltraps
8010655d:	e9 e5 f6 ff ff       	jmp    80105c47 <alltraps>
...
80106564:	6a 7f                	push   $0x7f
  jmp alltraps
80106566:	e9 dc f6 ff ff       	jmp    80105c47 <alltraps>
...
8010656d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106572:	e9 d0 f6 ff ff       	jmp    80105c47 <alltraps>
...
80106579:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010657e:	e9 c4 f6 ff ff       	jmp    80105c47 <alltraps>
...
80106585:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010658a:	e9 b8 f6 ff ff       	jmp    80105c47 <alltraps>
...
80106591:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106596:	e9 ac f6 ff ff       	jmp    80105c47 <alltraps>
...
8010659d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801065a2:	e9 a0 f6 ff ff       	jmp    80105c47 <alltraps>
...
801065a9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801065ae:	e9 94 f6 ff ff       	jmp    80105c47 <alltraps>
...
801065b5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801065ba:	e9 88 f6 ff ff       	jmp    80105c47 <alltraps>
...
801065c1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801065c6:	e9 7c f6 ff ff       	jmp    80105c47 <alltraps>
...
801065cd:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801065d2:	e9 70 f6 ff ff       	jmp    80105c47 <alltraps>
...
801065d9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801065de:	e9 64 f6 ff ff       	jmp    80105c47 <alltraps>
...
801065e5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801065ea:	e9 58 f6 ff ff       	jmp    80105c47 <alltraps>
...
801065f1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801065f6:	e9 4c f6 ff ff       	jmp    80105c47 <alltraps>
...
801065fd:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106602:	e9 40 f6 ff ff       	jmp    80105c47 <alltraps>
...
80106609:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010660e:	e9 34 f6 ff ff       	jmp    80105c47 <alltraps>
...
80106615:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010661a:	e9 28 f6 ff ff       	jmp    80105c47 <alltraps>
...
80106621:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106626:	e9 1c f6 ff ff       	jmp    80105c47 <alltraps>
...
8010662d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106632:	e9 10 f6 ff ff       	jmp    80105c47 <alltraps>
...
80106639:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010663e:	e9 04 f6 ff ff       	jmp    80105c47 <alltraps>
...
80106645:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010664a:	e9 f8 f5 ff ff       	jmp    80105c47 <alltraps>
...
80106651:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106656:	e9 ec f5 ff ff       	jmp    80105c47 <alltraps>
...
8010665d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106662:	e9 e0 f5 ff ff       	jmp    80105c47 <alltraps>
...
80106669:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010666e:	e9 d4 f5 ff ff       	jmp    80105c47 <alltraps>
...
80106675:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010667a:	e9 c8 f5 ff ff       	jmp    80105c47 <alltraps>
...
80106681:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106686:	e9 bc f5 ff ff       	jmp    80105c47 <alltraps>
...
8010668d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106692:	e9 b0 f5 ff ff       	jmp    80105c47 <alltraps>
...
80106699:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010669e:	e9 a4 f5 ff ff       	jmp    80105c47 <alltraps>
...
801066a5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801066aa:	e9 98 f5 ff ff       	jmp    80105c47 <alltraps>
...
801066b1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801066b6:	e9 8c f5 ff ff       	jmp    80105c47 <alltraps>
...
801066bd:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801066c2:	e9 80 f5 ff ff       	jmp    80105c47 <alltraps>
...
801066c9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801066ce:	e9 74 f5 ff ff       	jmp    80105c47 <alltraps>
...
801066d5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801066da:	e9 68 f5 ff ff       	jmp    80105c47 <alltraps>
...
801066e1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801066e6:	e9 5c f5 ff ff       	jmp    80105c47 <alltraps>
...
801066ed:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801066f2:	e9 50 f5 ff ff       	jmp    80105c47 <alltraps>
...
801066f9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801066fe:	e9 44 f5 ff ff       	jmp    80105c47 <alltraps>
...
80106705:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010670a:	e9 38 f5 ff ff       	jmp    80105c47 <alltraps>
...
80106711:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106716:	e9 2c f5 ff ff       	jmp    80105c47 <alltraps>
...
8010671d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106722:	e9 20 f5 ff ff       	jmp    80105c47 <alltraps>
...
80106729:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010672e:	e9 14 f5 ff ff       	jmp    80105c47 <alltraps>
...
80106735:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010673a:	e9 08 f5 ff ff       	jmp    80105c47 <alltraps>
...
80106741:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106746:	e9 fc f4 ff ff       	jmp    80105c47 <alltraps>
...
8010674d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106752:	e9 f0 f4 ff ff       	jmp    80105c47 <alltraps>
...
80106759:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010675e:	e9 e4 f4 ff ff       	jmp    80105c47 <alltraps>
...
80106765:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010676a:	e9 d8 f4 ff ff       	jmp    80105c47 <alltraps>
...
80106771:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106776:	e9 cc f4 ff ff       	jmp    80105c47 <alltraps>
...
8010677d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106782:	e9 c0 f4 ff ff       	jmp    80105c47 <alltraps>
...
80106789:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010678e:	e9 b4 f4 ff ff       	jmp    80105c47 <alltraps>
...
80106795:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010679a:	e9 a8 f4 ff ff       	jmp    80105c47 <alltraps>
...
801067a1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801067a6:	e9 9c f4 ff ff       	jmp    80105c47 <alltraps>
...
801067ad:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801067b2:	e9 90 f4 ff ff       	jmp    80105c47 <alltraps>
...
801067b9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801067be:	e9 84 f4 ff ff       	jmp    80105c47 <alltraps>
...
801067c5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801067ca:	e9 78 f4 ff ff       	jmp    80105c47 <alltraps>
...
801067d1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801067d6:	e9 6c f4 ff ff       	jmp    80105c47 <alltraps>
...
801067dd:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801067e2:	e9 60 f4 ff ff       	jmp    80105c47 <alltraps>
...
801067e9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801067ee:	e9 54 f4 ff ff       	jmp    80105c47 <alltraps>
...
801067f5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801067fa:	e9 48 f4 ff ff       	jmp    80105c47 <alltraps>
...
80106801:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106806:	e9 3c f4 ff ff       	jmp    80105c47 <alltraps>
...
8010680d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106812:	e9 30 f4 ff ff       	jmp    80105c47 <alltraps>
...
80106819:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010681e:	e9 24 f4 ff ff       	jmp    80105c47 <alltraps>
...
80106825:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010682a:	e9 18 f4 ff ff       	jmp    80105c47 <alltraps>
...
80106831:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106836:	e9 0c f4 ff ff       	jmp    80105c47 <alltraps>
...
8010683d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106842:	e9 00 f4 ff ff       	jmp    80105c47 <alltraps>
...
80106849:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010684e:	e9 f4 f3 ff ff       	jmp    80105c47 <alltraps>
...
80106855:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010685a:	e9 e8 f3 ff ff       	jmp    80105c47 <alltraps>
...
80106861:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106866:	e9 dc f3 ff ff       	jmp    80105c47 <alltraps>
...
8010686d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106872:	e9 d0 f3 ff ff       	jmp    80105c47 <alltraps>
...
80106879:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010687e:	e9 c4 f3 ff ff       	jmp    80105c47 <alltraps>
...
80106885:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010688a:	e9 b8 f3 ff ff       	jmp    80105c47 <alltraps>
...
80106891:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106896:	e9 ac f3 ff ff       	jmp    80105c47 <alltraps>
...
8010689d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801068a2:	e9 a0 f3 ff ff       	jmp    80105c47 <alltraps>
...
801068a9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801068ae:	e9 94 f3 ff ff       	jmp    80105c47 <alltraps>
...
801068b5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801068ba:	e9 88 f3 ff ff       	jmp    80105c47 <alltraps>
...
801068c1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801068c6:	e9 7c f3 ff ff       	jmp    80105c47 <alltraps>
...
801068cd:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801068d2:	e9 70 f3 ff ff       	jmp    80105c47 <alltraps>
...
801068d9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801068de:	e9 64 f3 ff ff       	jmp    80105c47 <alltraps>
...
801068e5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801068ea:	e9 58 f3 ff ff       	jmp    80105c47 <alltraps>
...
801068f1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801068f6:	e9 4c f3 ff ff       	jmp    80105c47 <alltraps>
...
801068fd:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106902:	e9 40 f3 ff ff       	jmp    80105c47 <alltraps>
...
80106909:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010690e:	e9 34 f3 ff ff       	jmp    80105c47 <alltraps>
...
80106915:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010691a:	e9 28 f3 ff ff       	jmp    80105c47 <alltraps>
...
80106921:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106926:	e9 1c f3 ff ff       	jmp    80105c47 <alltraps>
...
8010692d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106932:	e9 10 f3 ff ff       	jmp    80105c47 <alltraps>
...
80106939:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010693e:	e9 04 f3 ff ff       	jmp    80105c47 <alltraps>
...
80106945:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010694a:	e9 f8 f2 ff ff       	jmp    80105c47 <alltraps>
...
80106951:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106956:	e9 ec f2 ff ff       	jmp    80105c47 <alltraps>
...
8010695d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106962:	e9 e0 f2 ff ff       	jmp    80105c47 <alltraps>
...
80106969:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010696e:	e9 d4 f2 ff ff       	jmp    80105c47 <alltraps>
...
80106975:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010697a:	e9 c8 f2 ff ff       	jmp    80105c47 <alltraps>
...
80106981:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106986:	e9 bc f2 ff ff       	jmp    80105c47 <alltraps>
...
8010698d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106992:	e9 b0 f2 ff ff       	jmp    80105c47 <alltraps>
...
80106999:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010699e:	e9 a4 f2 ff ff       	jmp    80105c47 <alltraps>
...
801069a5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801069aa:	e9 98 f2 ff ff       	jmp    80105c47 <alltraps>
...
801069b1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801069b6:	e9 8c f2 ff ff       	jmp    80105c47 <alltraps>
...
801069bd:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801069c2:	e9 80 f2 ff ff       	jmp    80105c47 <alltraps>
...
801069c9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801069ce:	e9 74 f2 ff ff       	jmp    80105c47 <alltraps>
...
801069d5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801069da:	e9 68 f2 ff ff       	jmp    80105c47 <alltraps>
...
801069e1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801069e6:	e9 5c f2 ff ff       	jmp    80105c47 <alltraps>
...
801069ed:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801069f2:	e9 50 f2 ff ff       	jmp    80105c47 <alltraps>
...
801069f9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801069fe:	e9 44 f2 ff ff       	jmp    80105c47 <alltraps>
...
80106a05:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106a0a:	e9 38 f2 ff ff       	jmp    80105c47 <alltraps>
...
80106a11:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106a16:	e9 2c f2 ff ff       	jmp    80105c47 <alltraps>
...
80106a1d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106a22:	e9 20 f2 ff ff       	jmp    80105c47 <alltraps>
...
80106a29:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106a2e:	e9 14 f2 ff ff       	jmp    80105c47 <alltraps>
...
80106a35:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106a3a:	e9 08 f2 ff ff       	jmp    80105c47 <alltraps>
...
80106a41:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106a46:	e9 fc f1 ff ff       	jmp    80105c47 <alltraps>
...
80106a4d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106a52:	e9 f0 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106a59:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106a5e:	e9 e4 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106a65:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106a6a:	e9 d8 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106a71:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106a76:	e9 cc f1 ff ff       	jmp    80105c47 <alltraps>
...
80106a7d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106a82:	e9 c0 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106a89:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106a8e:	e9 b4 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106a95:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106a9a:	e9 a8 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106aa1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106aa6:	e9 9c f1 ff ff       	jmp    80105c47 <alltraps>
...
80106aad:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106ab2:	e9 90 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106ab9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106abe:	e9 84 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106ac5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106aca:	e9 78 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106ad1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106ad6:	e9 6c f1 ff ff       	jmp    80105c47 <alltraps>
...
80106add:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106ae2:	e9 60 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106ae9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106aee:	e9 54 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106af5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106afa:	e9 48 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106b01:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106b06:	e9 3c f1 ff ff       	jmp    80105c47 <alltraps>
...
80106b0d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106b12:	e9 30 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106b19:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106b1e:	e9 24 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106b25:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106b2a:	e9 18 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106b31:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106b36:	e9 0c f1 ff ff       	jmp    80105c47 <alltraps>
...
80106b3d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106b42:	e9 00 f1 ff ff       	jmp    80105c47 <alltraps>
...
80106b49:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106b4e:	e9 f4 f0 ff ff       	jmp    80105c47 <alltraps>
...
80106b55:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106b5a:	e9 e8 f0 ff ff       	jmp    80105c47 <alltraps>
...
80106b61:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106b66:	e9 dc f0 ff ff       	jmp    80105c47 <alltraps>
...
80106bca:	e8 b1 dd ff ff       	call   80104980 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106c6d:	68 90 7d 10 80       	push   $0x80107d90
...
80106d37:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106d3a:	e8 21 cc ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106dc4:	a1 e4 56 11 80       	mov    0x801156e4,%eax
...
80106e08:	0f 84 c2 00 00 00    	je     80106ed0 <switchuvm+0xf0>
  pushcli();
80106e0e:	e8 5d d9 ff ff       	call   80104770 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106e13:	e8 d8 ca ff ff       	call   801038f0 <mycpu>
80106e18:	89 c3                	mov    %eax,%ebx
80106e1a:	e8 d1 ca ff ff       	call   801038f0 <mycpu>
80106e1f:	89 c7                	mov    %eax,%edi
80106e21:	e8 ca ca ff ff       	call   801038f0 <mycpu>
80106e26:	83 c7 08             	add    $0x8,%edi
80106e29:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e2c:	e8 bf ca ff ff       	call   801038f0 <mycpu>
...
80106f23:	e8 58 da ff ff       	call   80104980 <memset>
...
80106f56:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106f57:	e9 c4 da ff ff       	jmp    80104a20 <memmove>
    panic("inituvm: more than a page");
80106f5c:	83 ec 0c             	sub    $0xc,%esp
80106f5f:	68 d5 7d 10 80       	push   $0x80107dd5
...
8010708b:	e8 f0 d8 ff ff       	call   80104980 <memset>
...
801070c9:	68 0d 7e 10 80       	push   $0x80107e0d
...
8010712b:	68 25 7e 10 80       	push   $0x80107e25
...
8010720c:	68 41 7e 10 80       	push   $0x80107e41
...
80107244:	e8 37 d7 ff ff       	call   80104980 <memset>
...
801072af:	a3 e4 56 11 80       	mov    %eax,0x801156e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801072e3:	68 52 7e 10 80       	push   $0x80107e52
...
80107330:	e8 eb d6 ff ff       	call   80104a20 <memmove>
...
801073c9:	68 76 7e 10 80       	push   $0x80107e76
801073ce:	e8 bd 8f ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801073d3:	83 ec 0c             	sub    $0xc,%esp
801073d6:	68 5c 7e 10 80       	push   $0x80107e5c
...
8010745e:	e8 bd d5 ff ff       	call   80104a20 <memmove>
    len -= n;
    buf += n;
